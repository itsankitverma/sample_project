...
public interface CODFacade extends javax.ejb.EJBObject {
    ...
    public Collection applyCODScans(Collection colChanges) throws RemoteException, FacadeException;
    ...
    public Collection getAllCOD_RecStatus() throws FacadeException, RemoteException;
    ...
    public boolean addCOD_Receivable(COD_ReceivablesVO recVO) throws RemoteException;

    public COD_ReceivablesVO getCOD_Receivables(int recPk) throws RemoteException;
    ...
    public Collection getCODUsedCurrencies(String locationCodePk, String employeeCodePk) throws RemoteException, FacadeException;
   ...
   // public boolean loadInvoices(Collection colRec, String filename) throws RemoteException, FacadeException;
    ...
    public Collection getCodFilesImportingStatus(String empId) throws RemoteException, FacadeException;
    ...
    public Collection getCodFilesImportingDetails(int logId) throws RemoteException, FacadeException;
    ...
    public TotalSummaryVO getCODDetailsTotal(String locationCodePk, String employeeCodePk, String currencyCode, Integer pageNumber, Integer rowsByPage, String sortColumn, String sortDirection) throws RemoteException, FacadeException;

    public TotalSummaryVO getCODDetailsSplitTotal(String locationCd, String employeeId, Integer pageNumber, Integer rowsByPage, String sortColumn, String sortDirection) throws RemoteException, FacadeException;
}
