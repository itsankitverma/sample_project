 ...
 * @author ccardenas
 */
public class FTCDaoBean implements javax.ejb.SessionBean {
    ...
    public java.util.Collection getAwbToQueryCosmos(java.lang.String locationCd, java.lang.String employeeId) throws DAOException {
        ...
        try {
            ...
            cs = conn.prepareCall("BEGIN SP_GET_F_AWBS_TO_QUERY_COSMOS(?,?,?); END;");

   			//Constants.logger.debug("Inside FTCDaoBean.java > getAwbToQueryCosmos > locationCD = "+locationCd+" - EmployeeID = "+ employeeId);
            ...
            while (rs.next()) {
                FTC_RecChangesFromScans recChanges = new FTC_RecChangesFromScans();
                recChanges.setRecId(rs.getInt(1));
                recChanges.setRecAwbNumber(rs.getString(2));
                
                //Constants.logger.debug("Inside FTCDaoBean.java > Awb # rs.getString(2) = "+rs.getString(2));
            ...
            //Constants.logger.debug("Inside FTCDaoBean.java > Size of awb collections = "+col.size());
            return col;
        } catch (Exception e) {
    ...
    public java.util.Hashtable getCourierCashRecapTable(String locationCd, String employeeId, String currencyCode, Integer pageNumber, Integer rowsByPage, String sortColumn, String sortDirection) throws DAOException {
        ...
        try {
         /*   Hashtable prop=new Hashtable();
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareCall("BEGIN SP_FTC_COURIER_CASH_RECAP(?,?,?,?,?,?,?,?,?); END;");
            cs.setString(1, locationCd);
            cs.setString(2, employeeId);
            ...
            while (rs.next()) {
                FTC_CourierCashRecapTableVO ccrVO = new FTC_CourierCashRecapTableVO();
                ...
                ccrVO.setFtcAmt(rs.getDouble(16));
            ...
            throw new DAOException(e.toString() + " ocurred on getCourierCashRecapTable() method of FTCDaoBean class.", e);
        }
        finally {
            try {
                if (rs != null) rs.close();
    ...
    public java.util.Collection getAllFTC_RecStatus() throws DAOException {
        Connection conn = null;
        ...
        try {
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareStatement("SELECT STATUS_ID_NBR, STATUS_DESC FROM FTC_REC_STATUS WHERE FTC_PG_FLG=1");
            ...
            throw new DAOException(e.toString() + " ocurred on getAllFTC_RecStatus() method of FTCDaoBean class.", e);
        } finally {
            try {
                if (rs != null) rs.close();
            } catch (Exception e) {
    ...
    public Collection applyFTCScans(Collection colChanges) throws DAOException {
        ...
        try {
           ...
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareCall("BEGIN SP_FTC_APPLY_SCANS(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?); END;");
                ...
                if (cs.getString(19) != null && !"".equals(cs.getString(19))) {
                    if ("app.messages.EmployeeNonExist".equals(cs.getString(19))){
                        ...
                        try{
                            ...
                            if(eVOLdap==null){
                               eVOLdap=new EmployeeVO(recChanges.getRecEmployeeId(),"Unknown Employee","",recChanges.getRecEmployeeId()+"@fedex.com","FTC",null,"0",0, null, 0, 0,null,1);
                            }
            ...
            throw new DAOException(e.toString() + " SQLException ocurred on applyFTCScans() method of FTCDaoBean class.", e);
        } catch (NamingException e) {
            context.setRollbackOnly();
            throw new DAOException(e.toString() + " NamingException ocurred on applyFTCScans() method of FTCDaoBean class.", e);
        } catch (Exception e) {
            context.setRollbackOnly();
            throw new DAOException(e.toString() + " Exception ocurred on applyFTCScans() method of FTCDaoBean class.", e);
        } finally {
            try {
                if (cs != null) cs.close();
            } catch (Exception e) {
                throw new DAOException(e.toString() + "  ocurred when trying to close callable statement on applyFTCScans() method of FTCDaoBean class.", e);
            }
            try {
                if (conn != null) conn.close();
            } catch (Exception e) {
                throw new DAOException(e.toString() + " ocurred when trying to close connection on applyFTCScans() method of FTCDaoBean class.", e);
            }
 ...
 /*           Hashtable prop=new Hashtable();
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareCall("BEGIN SP_GET_FTC_INVOICES_BY_AWB(?,?); END;");
            ...
            throw new DAOException(e.toString() + " ocurred on getInvoicesByAwb() method of FTCDaoBean class.", e);
        } finally {
            try {
                if (rs != null) rs.close();
            } catch (Exception e) {
    ...
    public Collection getCouriersWithPendents(String location) throws DAOException {
        ...
        try {
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareCall("BEGIN SP_FTC_COURIER_WITH_PENDENT(?,?); END;");
            ...
            throw new DAOException(e.toString() + " ocurred on getCouriersWithPendents() method of FTCDaoBean class.", e);
        } finally {
            try {
                if (rs != null) rs.close();
            } catch (Exception e) {
    ...
    public java.util.Collection getFTCUsedCurrencies(String locationCd, String employeeId) throws DAOException {
        Connection conn = null;
        CallableStatement cs = null;
        ResultSet rs = null;
        try {
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareCall("BEGIN SP_GET_FTC_USED_CURRENCIES(?,?,?); END;");
            ...
            throw new DAOException(e.toString() + " ocurred on getFTCUsedCurrencies() method of FTCDaoBean class.", e);
        } finally {
            try {
                if (rs != null) rs.close();
            } catch (Exception e) {
    ...
    public void runInCageExceptionsTask() throws DAOException {
        ...
        try {
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            conn = ds.getConnection();
            cs = conn.prepareCall("BEGIN SP_FTC_INCAGE_EXCEPTIONS_TRACK; END;");

            cs.execute();

        } catch (Exception e) {
            throw new DAOException(e.toString() + " ocurred on runInCageExceptionsTask() method of FTCDaoBean class.", e);
        } finally {
            try {
                if (cs != null) cs.close();
            } catch (Exception e) {
    ...
    public java.util.Collection getAwbToQuerySTAT44() throws DAOException {
        ...
        try {
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareCall("BEGIN SP_GET_FTC_AWB_TO_QUERY_STAT44(?); END;");
    ...
    public boolean existsFileProcessed(String fileName) throws DAOException {
        ...
        try {
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareStatement("SELECT COUNT(*) FROM FTC_FILE_PROC_LOG WHERE FILE_NM= ? AND STATUS_CD=1");
            ...
            throw new DAOException(e.toString() + " ocurred on existsEmployeeLocation() method of FTCDaoBean class.", e);
        } finally {
            try {
                if (rs != null) rs.close();
            } catch (Exception e) {
    ...
    public boolean existsRecDuplicates(com.fedex.lacitd.cashcontrol.datatier.valueobject.FTC_ReceivablesVO recVO) throws DAOException {
        Connection conn = null;
        PreparedStatement cs = null;
        ResultSet rs = null;
        try {
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareStatement("SELECT COUNT(*) FROM FTC_RECEIVABLES WHERE FTC_REC_ID_NBR<>? AND NVL(FTC_REC_NBR,'K')=NVL(?,'K') AND TO_CHAR(FTC_REC_DT,'DD/MM/YYYY')=TO_CHAR(?,'DD/MM/YYYY') AND FTC_REC_AMT=? AND AWB_NBR=? AND LOC_CD IN (SELECT LOC_CD FROM LOCATION WHERE LOC_CD=? OR PARNT_LOC_CD=?)");
            ...
            throw new DAOException(e.toString() + " ocurred on existsRecDuplicates() method of FTCDaoBean class.", e);
        } finally {
            try {
                if (rs != null) rs.close();
            } catch (Exception e) {
    ...
    public java.util.Collection getFtcFilesImportingStatus(String empId) throws DAOException {
        Connection conn = null;
        CallableStatement cs = null;
        ResultSet rs = null;
        try {
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareCall("BEGIN SP_IMPORT_FTC_FILES_REPORT(?,?); END;");
            ...
            Collection colDet = new ArrayList();
            while (rs.next()) {
                FtcFileProcLogVO ccrVO = new FtcFileProcLogVO();
                ccrVO.setFtcFilePrLogId(new Integer(rs.getInt(1)));
            ...
            throw new DAOException(e.toString() + " ocurred on getFTCFilesImportingStatus() method of FTCDaoBean class.", e);
        } finally {
            try {
                if (rs != null) rs.close();
            } catch (Exception e) {
    ...
    public java.util.Collection getFtcFilesImportingDetails(int logId) throws DAOException {
        Connection conn = null;
        CallableStatement cs = null;
        ResultSet rs = null;
        try {
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareCall("BEGIN SP_IMPORT_FTC_FILES_DETAILS(?,?); END;");
            ...
            Collection colDet = new ArrayList();
            while (rs.next()) {
                FTC_ReceivablesVO ccrVO = new FTC_ReceivablesVO();
            ...
            throw new DAOException(e.toString() + " ocurred on getFtcFilesImportingDetails() method of FTCDaoBean class.", e);
        } finally {
            try {
                if (rs != null) rs.close();
            } catch (Exception e) {
    ...
    public void insertFTCFileProcLog(com.fedex.lacitd.cashcontrol.datatier.valueobject.FtcFileProcLogVO ftcVO) throws DAOException {
        ...
        try {
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareStatement("INSERT INTO FTC_FILE_PROC_LOG (FTC_FILE_PR_LOG_ID_NBR,FILE_NM,LOC_CD,PRCS_DT,STATUS_CD,MSG_CD,AWB_QTY,ERROR_DTL_DESC,TOTAL_LOCAL_AMT,TOTAL_USD_AMT) VALUES (FTC_FILE_PROC_LOG_SEQ.NEXTVAL,?,?,?,?,?,?,?,?,?)");
            cs.setString(1, ftcVO.getFileNm());
            cs.setString(2, ftcVO.getLocationCd());
            cs.setTimestamp(3, new java.sql.Timestamp(ftcVO.getProcessDt().getTime()));
            cs.setInt(4, ftcVO.getStatusCd());
            cs.setString(5, ftcVO.getMessage());
            cs.setInt(6, ftcVO.getAwbQty());
            cs.setString(7, ftcVO.getErrorDtlDesc());
            cs.setDouble(8, ftcVO.getTotalLocalAmt());
            cs.setDouble(9, ftcVO.getTotalUsdAmt());

            cs.execute();
        } catch (Exception e) {
            throw new DAOException(e.toString() + " ocurred on insertFTCFileProcLog() method of FTCDaoBean class.", e);
        } finally {
            try {
                if (rs != null) rs.close();
            } catch (Exception e) {
    ...
    public java.util.Hashtable getSplitCourierCashRecapTable(String locationCd, String employeeId, Integer pageNumber, Integer rowsByPage, String sortColumn, String sortDirection) throws DAOException {
        ...
        try {
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareCall("BEGIN SP_SPLIT_FTC_PAYMENTS(?,?,?,?,?,?,?,?); END;");
            ...
            while (rs.next()) {
                ...
                ccrVO.setFtcAmt(rs.getDouble(18));
    ...
    public Collection applyPaymentToInvoices(String courierId, String locationCd, String countryCd, String paymentCurrency, int paymentType, String otherDocNbr, boolean isCash, boolean isFindByAWB, Collection invoices) throws DAOException {
        ...
        try {
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            sb = new StringBuffer("UPDATE FTC_RECEIVABLES r\n");
            ...
            if (!isCash) {
                ...
                sb.append("	   OTHER_PYMT_AMT=FTC_REC_AMT, ");
            } else {
                sb.append("	   CASH_PYMT_AMT=FTC_REC_AMT, ");
            }
            ...
            if (isFindByAWB) {
                ...
                sb.append("AND TO_CHAR(SUBSTR(FTC_REC_NBR,INSTR(FTC_REC_NBR,'-',-1)+1)) = ? ");
            }
            ...
            throw new DAOException(e.toString() + " ocurred on applyPaymentToInvoices() method of FTCDaoBean class.", e);
        } finally {
            try {
                if (cs != null) cs.close();
            } catch (Exception e) {
    ...
    public TotalSummaryVO getFTCDetailsTotal(String locationCd,
                                             String employeeId,
                                             String currencyCode,
                                             Integer pageNumber,
                                             Integer rowsByPage,
        ...
        try {
           /*/* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareCall("BEGIN SP_CALC_FTC_TOTALS(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?); END;");
            cs.setString(1, locationCd);
            cs.setString(2, employeeId);
            cs.setString(3, currencyCode);
            cs.setInt(4, pageNumber.intValue());
            ...
            throw new DAOException(e.toString() + " ocurred on getFTCDetailsTotal() method of FTCDaoBean class.", e);
        }
        finally {
            try {
                if (cs != null) cs.close();
    ...
    public TotalSummaryVO getFTCDetailsSplitTotal(String locationCd,
                                                  String employeeId,
                                                  Integer pageNumber,
                                                  Integer rowsByPage,
                                                  String sortColumn,
        ...
        try {
           /*/* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareCall("BEGIN SP_CALC_SPLIT_FTC_TOTALS(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?); END;");
            cs.setString(1, locationCd);
            cs.setString(2, employeeId);
            cs.setInt(3, pageNumber.intValue());
            cs.setInt(4, rowsByPage.intValue());
            ...
            throw new DAOException(e.toString() + " ocurred on getFTCDetailSplitTotal() method of FTCDaoBean class.", e);
        }
        finally {
            try {
                if (cs != null) cs.close();
