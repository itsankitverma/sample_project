...
import com.fedex.lacitd.cashcontrol.datatier.valueobject.CodFileProcLogVO;
...
public interface CODDao extends javax.ejb.EJBObject {
    ...
    public Collection getAllCOD_RecStatus() throws RemoteException, DAOException, RemoteException;
    ...
    public Collection getCodFilesImportingStatus(String empId) throws RemoteException, DAOException;

    public boolean existsRecDuplicates(COD_ReceivablesVO recVO) throws RemoteException, DAOException;

    public Collection getCODUsedCurrencies(String locationCd, String employeeId) throws RemoteException, DAOException;

    public void runInCageExceptionsTask() throws RemoteException, DAOException;

    public Collection applyCODScans(Collection colChanges) throws RemoteException, DAOException;

    public boolean existsFileProcessed(String fileName) throws RemoteException, DAOException;

    //public void insertCODFileProcLog(CodFileProcLogVO codVO) throws RemoteException, DAOException;

    public Collection getCodFilesImportingDetails(int logId) throws DAOException, RemoteException;
    ...
    public TotalSummaryVO getCODDetailsTotal(String locationCd, String employeeId, String currencyCode, Integer pageNumber, Integer rowsByPage, String sortColumn, String sortDirection) throws RemoteException, DAOException;

    public TotalSummaryVO getCODDetailsSplitTotal(String locationCd, String employeeId, Integer pageNumber, Integer rowsByPage, String sortColumn, String sortDirection) throws RemoteException, DAOException;
}
