 ...
 * @author ccardenas
 */
public class CODDaoBean implements javax.ejb.SessionBean {
    ...
    public java.util.Collection getAwbToQueryCosmos(java.lang.String locationCd, java.lang.String employeeId) throws DAOException {
        ...
        try {
            ...
            cs = conn.prepareCall("BEGIN SP_GET_C_AWBS_TO_QUERY_COSMOS(?,?,?); END;");

   			//Constants.logger.debug("Inside CODDaoBean.java > getAwbToQueryCosmos > locationCD = "+locationCd+" - EmployeeID = "+ employeeId);
            ...
            while (rs.next()) {
                COD_RecChangesFromScans recChanges = new COD_RecChangesFromScans();
                recChanges.setRecId(rs.getInt(1));
                recChanges.setRecAwbNumber(rs.getString(2));
                
                //Constants.logger.debug("Inside CODDaoBean.java > Awb # rs.getString(2) = "+rs.getString(2));
            ...
            //Constants.logger.debug("Inside CODDaoBean.java > Size of awb collections = "+col.size());
            return col;
        } catch (Exception e) {
    ...
    public java.util.Hashtable getCourierCashRecapTable(String locationCd, String employeeId, String currencyCode, Integer pageNumber, Integer rowsByPage, String sortColumn, String sortDirection) throws DAOException {
        ...
        try {
         /*   Hashtable prop=new Hashtable();
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareCall("BEGIN SP_COD_COURIER_CASH_RECAP(?,?,?,?,?,?,?,?,?); END;");
            cs.setString(1, locationCd);
            cs.setString(2, employeeId);
            ...
            while (rs.next()) {
                COD_CourierCashRecapTableVO ccrVO = new COD_CourierCashRecapTableVO();
                ...
                ccrVO.setRecDex11Amount(rs.getDouble(6));
                ...
                ccrVO.setCodAmt(rs.getDouble(16));
                ...
                //changes needed to be done here to reflect the values for the two columns miscDate, miscNbr
...
//                String miscQry = "select MISCELLANEOUS_DATE, MISCELLANEOUS_NBR from COD_Receivables where COD_REC_ID_NBR=" + ccrVO.getRecId();
...
//                }                
            ...
            throw new DAOException(e.toString() + " ocurred on getCourierCashRecapTable() method of CODDaoBean class.", e);
        }
        finally {
            try {
                if (rs != null) rs.close();
    ...
    public java.util.Collection getAllCOD_RecStatus() throws DAOException {
        Connection conn = null;
        ...
        try {
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareStatement("SELECT STATUS_ID_NBR, STATUS_DESC FROM COD_REC_STATUS WHERE COD_PG_FLG=1");
            ...
            throw new DAOException(e.toString() + " ocurred on getAllCOD_RecStatus() method of CODDaoBean class.", e);
        } finally {
            try {
                if (rs != null) rs.close();
            } catch (Exception e) {
    ...
    public Collection applyCODScans(Collection colChanges) throws DAOException {
        ...
        try {
           ...
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareCall("BEGIN SP_COD_APPLY_SCANS(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?); END;");
            ...
            while (iterChanges.hasNext())
            {
                ...
                {
                    recChanges.setRecDex11CashPayment( Utils.convertToNewCurrency( recChanges.getRecDex11CashPayment(), recChanges.getLocationCd()));
                    recChanges.setRecDex11OtherPayment( Utils.convertToNewCurrency( recChanges.getRecDex11OtherPayment(), recChanges.getLocationCd()));
                    recChanges.setRecDex11FreightAmount( Utils.convertToNewCurrency( recChanges.getRecDex11FreightAmount(), recChanges.getLocationCd()));
                ...
                */
                ...
                cs.setDouble(10, recChanges.getRecDex11CashPayment());
                cs.setDouble(11, recChanges.getRecDex11OtherPayment());
                cs.setString(12, recChanges.getRecDex11CosmosScanSeqNbr());
                cs.setDouble(13, recChanges.getRecDex11FreightAmount());
                ...
                if (cs.getString(19) != null && !"".equals(cs.getString(19))) {
                    if ("app.messages.EmployeeNonExist".equals(cs.getString(19))){
                        ...
                        try{
                            ...
                            if(eVOLdap==null){
                               eVOLdap=new EmployeeVO(recChanges.getRecEmployeeId(),"Unknown Employee","",recChanges.getRecEmployeeId()+"@fedex.com","COD",null,"0",0, null, 0, 0,null,1);
                            }
            ...
            throw new DAOException(e.toString() + " SQLException ocurred on applyCODScans() method of CODDaoBean class.", e);
        } catch (NamingException e) {
            context.setRollbackOnly();
            throw new DAOException(e.toString() + " NamingException ocurred on applyCODScans() method of CODDaoBean class.", e);
        } catch (Exception e) {
            context.setRollbackOnly();
            throw new DAOException(e.toString() + " Exception ocurred on applyCODScans() method of CODDaoBean class.", e);
        } finally {
            try {
                if (cs != null) cs.close();
            } catch (Exception e) {
                throw new DAOException(e.toString() + "  ocurred when trying to close callable statement on applyCODScans() method of CODDaoBean class.", e);
            }
            try {
                if (conn != null) conn.close();
            } catch (Exception e) {
                throw new DAOException(e.toString() + " ocurred when trying to close connection on applyCODScans() method of CODDaoBean class.", e);
            }
 ...
 /*           Hashtable prop=new Hashtable();
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareCall("BEGIN SP_GET_COD_INVOICES_BY_AWB(?,?); END;");
            ...
            throw new DAOException(e.toString() + " ocurred on getInvoicesByAwb() method of CODDaoBean class.", e);
        } finally {
            try {
                if (rs != null) rs.close();
            } catch (Exception e) {
    ...
    public Collection getCouriersWithPendents(String location) throws DAOException {
        ...
        try {
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareCall("BEGIN SP_COD_COURIER_WITH_PENDENT(?,?); END;");
            ...
            throw new DAOException(e.toString() + " ocurred on getCouriersWithPendents() method of CODDaoBean class.", e);
        } finally {
            try {
                if (rs != null) rs.close();
            } catch (Exception e) {
    ...
    public java.util.Collection getCODUsedCurrencies(String locationCd, String employeeId) throws DAOException {
        Connection conn = null;
        CallableStatement cs = null;
        ResultSet rs = null;
        try {
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareCall("BEGIN SP_GET_COD_USED_CURRENCIES(?,?,?); END;");
            ...
            throw new DAOException(e.toString() + " ocurred on getCODUsedCurrencies() method of CODDaoBean class.", e);
        } finally {
            try {
                if (rs != null) rs.close();
            } catch (Exception e) {
    ...
    public void runInCageExceptionsTask() throws DAOException {
        ...
        try {
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            conn = ds.getConnection();
            cs = conn.prepareCall("BEGIN SP_COD_INCAGE_EXCEPTIONS_TRACK; END;");

            cs.execute();

        } catch (Exception e) {
            throw new DAOException(e.toString() + " ocurred on runInCageExceptionsTask() method of CODDaoBean class.", e);
        } finally {
            try {
                if (cs != null) cs.close();
            } catch (Exception e) {
    ...
    public java.util.Collection getAwbToQuerySTAT44() throws DAOException {
        ...
        try {
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareCall("BEGIN SP_GET_COD_AWB_TO_QUERY_STAT44(?); END;");
    ...
    public boolean existsFileProcessed(String fileName) throws DAOException {
        ...
        try {
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareStatement("SELECT COUNT(*) FROM COD_FILE_PROC_LOG WHERE FILE_NM= ? AND STATUS_CD=1");
            ...
            throw new DAOException(e.toString() + " ocurred on existsEmployeeLocation() method of CODDaoBean class.", e);
        } finally {
            try {
                if (rs != null) rs.close();
            } catch (Exception e) {
    ...
    public boolean existsRecDuplicates(com.fedex.lacitd.cashcontrol.datatier.valueobject.COD_ReceivablesVO recVO) throws DAOException {
        Connection conn = null;
        PreparedStatement cs = null;
        ResultSet rs = null;
        try {
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareStatement("SELECT COUNT(*) FROM COD_RECEIVABLES WHERE COD_REC_ID_NBR<>? AND NVL(COD_REC_NBR,'K')=NVL(?,'K') AND TO_CHAR(COD_REC_DT,'DD/MM/YYYY')=TO_CHAR(?,'DD/MM/YYYY') AND COD_REC_AMT=? AND AWB_NBR=? AND LOC_CD IN (SELECT LOC_CD FROM LOCATION WHERE LOC_CD=? OR PARNT_LOC_CD=?)");
            ...
            throw new DAOException(e.toString() + " ocurred on existsRecDuplicates() method of CODDaoBean class.", e);
        } finally {
            try {
                if (rs != null) rs.close();
            } catch (Exception e) {
    ...
    public java.util.Collection getCodFilesImportingStatus(String empId) throws DAOException {
        Connection conn = null;
        CallableStatement cs = null;
        ResultSet rs = null;
        try {
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareCall("BEGIN SP_IMPORT_COD_FILES_REPORT(?,?); END;");
            ...
            Collection colDet = new ArrayList();
            while (rs.next()) {
                CodFileProcLogVO ccrVO = new CodFileProcLogVO();
                ccrVO.setCodFilePrLogId(new Integer(rs.getInt(1)));
            ...
            throw new DAOException(e.toString() + " ocurred on getCodFilesImportingStatus() method of CODDaoBean class.", e);
        } finally {
            try {
                if (rs != null) rs.close();
            } catch (Exception e) {
    ...
    public java.util.Collection getCodFilesImportingDetails(int logId) throws DAOException {
        Connection conn = null;
        CallableStatement cs = null;
        ResultSet rs = null;
        try {
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareCall("BEGIN SP_IMPORT_COD_FILES_DETAILS(?,?); END;");
            ...
            Collection colDet = new ArrayList();
            while (rs.next()) {
                COD_ReceivablesVO ccrVO = new COD_ReceivablesVO();
            ...
            throw new DAOException(e.toString() + " ocurred on getCodFilesImportingDetails() method of CODDaoBean class.", e);
        } finally {
            try {
                if (rs != null) rs.close();
            } catch (Exception e) {
    ...
    public void insertCODFileProcLog(com.fedex.lacitd.cashcontrol.datatier.valueobject.CodFileProcLogVO codVO) throws DAOException {
        ...
        try {
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareStatement("INSERT INTO COD_FILE_PROC_LOG (COD_FILE_PR_LOG_ID_NBR,FILE_NM,LOC_CD,PRCS_DT,STATUS_CD,MSG_CD,AWB_QTY,ERROR_DTL_DESC,TOTAL_LOCAL_AMT,TOTAL_USD_AMT) VALUES (COD_FILE_PROC_LOG_SEQ.NEXTVAL,?,?,?,?,?,?,?,?,?)");
            cs.setString(1, codVO.getFileNm());
            cs.setString(2, codVO.getLocationCd());
            cs.setTimestamp(3, new java.sql.Timestamp(codVO.getProcessDt().getTime()));
            cs.setInt(4, codVO.getStatusCd());
            cs.setString(5, codVO.getMessage());
            cs.setInt(6, codVO.getAwbQty());
            cs.setString(7, codVO.getErrorDtlDesc());
            cs.setDouble(8, codVO.getTotalLocalAmt());
            cs.setDouble(9, codVO.getTotalUsdAmt());

            cs.execute();
        } catch (Exception e) {
            throw new DAOException(e.toString() + " ocurred on insertCODFileProcLog() method of CODDaoBean class.", e);
        } finally {
            try {
                if (rs != null) rs.close();
            } catch (Exception e) {
    ...
    public java.util.Hashtable getSplitCourierCashRecapTable(String locationCd, String employeeId, Integer pageNumber, Integer rowsByPage, String sortColumn, String sortDirection) throws DAOException {
        ...
        try {
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareCall("BEGIN SP_SPLIT_COD_PAYMENTS(?,?,?,?,?,?,?,?); END;");
            ...
            while (rs.next()) {
                ...
                ccrVO.setRecDex11Amount(rs.getDouble(7));
                ...
                ccrVO.setCodAmt(rs.getDouble(18));
    ...
    public Collection applyPaymentToInvoices(String courierId, String locationCd, String countryCd, String paymentCurrency, int paymentType, String otherDocNbr, boolean isCash, boolean isFindByAWB, Collection invoices) throws DAOException {
        ...
        try {
           /* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            sb = new StringBuffer("UPDATE COD_RECEIVABLES r\n");
            ...
            if (!isCash) {
                ...
                sb.append("	   OTHER_PYMT_AMT=COD_REC_AMT, ");
            } else {
                sb.append("	   CASH_PYMT_AMT=COD_REC_AMT, ");
            }
            ...
            if (isFindByAWB) {
                ...
                sb.append("AND TO_CHAR(SUBSTR(COD_REC_NBR,INSTR(COD_REC_NBR,'-',-1)+1)) = ? ");
            }
            ...
            throw new DAOException(e.toString() + " ocurred on applyPaymentToInvoices() method of CODDaoBean class.", e);
        } finally {
            try {
                if (cs != null) cs.close();
            } catch (Exception e) {
    ...
    public TotalSummaryVO getCODDetailsTotal(String locationCd,
                                             String employeeId,
                                             String currencyCode,
                                             Integer pageNumber,
                                             Integer rowsByPage,
        ...
        try {
           /*/* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareCall("BEGIN SP_CALC_COD_TOTALS(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?); END;");
            cs.setString(1, locationCd);
            cs.setString(2, employeeId);
            cs.setString(3, currencyCode);
            cs.setInt(4, pageNumber.intValue());
            ...
            throw new DAOException(e.toString() + " ocurred on getCODDetailsTotal() method of CODDaoBean class.", e);
        }
        finally {
            try {
                if (cs != null) cs.close();
    ...
    public TotalSummaryVO getCODDetailsSplitTotal(String locationCd,
                                                  String employeeId,
                                                  Integer pageNumber,
                                                  Integer rowsByPage,
                                                  String sortColumn,
        ...
        try {
           /*/* Hashtable prop=new Hashtable();             prop.put(Context.SECURITY_PRINCIPAL,Constants.WLUSER);             prop.put(Context.SECURITY_CREDENTIALS,Constants.WLPWD);*/
            ...
            DataSource ds = (DataSource) c.lookup(Constants.CCSDataSource);
            conn = ds.getConnection();
            cs = conn.prepareCall("BEGIN SP_CALC_SPLIT_COD_TOTALS(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?); END;");
            cs.setString(1, locationCd);
            cs.setString(2, employeeId);
            cs.setInt(3, pageNumber.intValue());
            cs.setInt(4, rowsByPage.intValue());
            ...
            throw new DAOException(e.toString() + " ocurred on getCODDetailSplitTotal() method of CODDaoBean class.", e);
        }
        finally {
            try {
                if (cs != null) cs.close();
