...
public interface RODFacadeLocal extends javax.ejb.EJBLocalObject {
    ...
    public Collection applyScans(Collection colChanges) throws com.fedex.lacitd.cashcontrol.biztier.exception.FacadeException;
    ...
    public Collection getRODUsedCurrencies(String locationCodePk, String employeeCodePk) throws FacadeException;
