...
public class FTC_ReceivablesControllerTest {
	
	FTC_ReceivablesController ftc_ReceivablesController = new FTC_ReceivablesController();
	...
	@Test
	public void testSetFTC_Receivables() throws BusinessDelegateException {
		ftc_ReceivablesController.setFTC_Receivables(FTC_receivablesVO);
	}
	
	@Test
	public void testGetFTC_Receivables() throws BusinessDelegateException {
		int recId = 575989;
		ftc_ReceivablesController.getFTC_Receivables(recId);
	}
	
	@Test
	public void testGetAllFTC_Receivables() throws BusinessDelegateException {
		ftc_ReceivablesController.getAllFTC_Receivables();
	}
	
	@Test
	public void testGetFTC_ReceivablesReceivablesByAwbNbr() throws BusinessDelegateException {
		String awbNbr = "505144746947";
		ftc_ReceivablesController.getFTC_ReceivablesReceivablesByAwbNbr(awbNbr);
	}
	
	@Test
	public void testGetFTC_ReceivablesByEodId() throws BusinessDelegateException {
		int eodId = 120;
		ftc_ReceivablesController.getFTC_ReceivablesByEodId(eodId);
	}
	
	@Test
	public void testRemoveFTC_Receivables() throws BusinessDelegateException {
		int recId = 575989;
		ftc_ReceivablesController.removeFTC_Receivables(recId);
	}
	
	@Test
	public void testUpdateFTC_Receivables() throws BusinessDelegateException {
		ftc_ReceivablesController.updateFTC_Receivables(FTC_receivablesVO);
	}
	
	@Test
	public void tesGetFTC_ReceivablesManager() throws BusinessDelegateException {
		ftc_ReceivablesController.getFTC_ReceivablesManager();
	}
}
