/**
 * @(#)CreditCardPaymentManager.java			Tue Aug 02 15:38:51 VET 2005
 * 
 * FedEx
 * Cash Control
 * 
...
public interface CreditCardPaymentManager extends EJBObject {
    ...
    public void setCreditCardPayment(CreditCardPaymentVO creditCardPaymentVO)
        throws RemoteException, CreditCardPaymentException;
