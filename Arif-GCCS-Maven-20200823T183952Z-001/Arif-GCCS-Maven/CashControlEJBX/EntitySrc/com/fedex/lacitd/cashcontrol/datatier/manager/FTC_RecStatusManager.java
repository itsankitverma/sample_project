/**
 * @(#)FTC_RecStatusManager.java			Tue Aug 02 15:38:51 VET 2005
 * 
 * FedEx
 * Cash Control
 * 
...
public interface FTC_RecStatusManager extends EJBObject {
    ...
    public void setFTC_RecStatus(FTC_RecStatusVO FTC_recStatusVO)
        throws RemoteException, FTC_RecStatusException;
