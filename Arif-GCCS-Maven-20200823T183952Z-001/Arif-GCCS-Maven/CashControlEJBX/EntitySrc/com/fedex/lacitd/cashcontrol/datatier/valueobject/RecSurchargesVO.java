/**
 * @(#)RecSurchargesVO.java			Tue Aug 02 15:38:51 VET 2005
 * 
 * FedEx
 * Cash Control
 * 
...
public class RecSurchargesVO implements java.io.Serializable {

    private Integer _recId;
    private String _surchargeCd;
    private double _appliedAmt;
    public RecSurchargesVO() {
    }
    public RecSurchargesVO(Integer recId, String surchargeCd, double appliedAmt) {
        _recId = recId;
     ...
     */
    public RecSurchargesPK getRecSurchargesPK() {
        return new RecSurchargesPK(_recId, _surchargeCd);
    }
