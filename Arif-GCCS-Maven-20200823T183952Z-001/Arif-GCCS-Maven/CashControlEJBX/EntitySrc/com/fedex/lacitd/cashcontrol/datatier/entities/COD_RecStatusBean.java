...
public abstract class COD_RecStatusBean implements EntityBean {

    private EntityContext _ctx;
    public COD_RecStatusBean() {
    }
    /**
     ...
     * @param codPgFlg - int of codPgFlg
     */
    public abstract void setCodPgFlg(int codPgFlg);

    /**
     * Get the value of codPgFlg
     * @return codPgFlg - int of codPgFlg
     */
    public abstract int getCodPgFlg();

    /**
     * This is the initialization method that corresponds to the
     * create() method in the Home interface
     */
    public java.lang.Integer ejbCreate(Integer statusId, String description, int codPgFlg)
        throws CreateException {
        setStatusId(statusId);
        setDescription(description);
        setCodPgFlg(codPgFlg);
        return null;
    }
     ...
     */
    public void ejbPostCreate(Integer statusId, String description, int codPgFlg)
        throws CreateException {
    }
