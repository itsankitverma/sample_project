/**
 * @(#)PaymentCtgBean.java			Tue Aug 02 15:38:50 VET 2005
 * 
 * FedEx
 * Cash Control
 * 
...
public abstract class PaymentCtgBean implements EntityBean {

    private EntityContext _ctx;
    public PaymentCtgBean() {
    }
    /**
     * Set the value of paymentCtgId
     * @param paymentCtgId - Integer of paymentCtgId
     */
    public abstract void setPaymentCtgId(Integer paymentCtgId);

    /**
     * Get the value of paymentCtgId
     * @return paymentCtgId - Integer of paymentCtgId
     */
    public abstract Integer getPaymentCtgId();
     ...
     */
    public abstract void setCanCreatePymt(int canCreatePymt);

    /**
     * Get the value of canCreatePymt
     * @return canCreatePymt - int of canCreatePymt
     */
    public abstract int getCanCreatePymt();

    /**
     * This is the initialization method that corresponds to the
     * create() method in the Home interface
     */
    public java.lang.Integer ejbCreate(String description, int canCreatePymt)
        throws CreateException {
        setDescription(description);
        setCanCreatePymt(canCreatePymt);
        return null;
    }
     ...
     */
    public void ejbPostCreate(String description, int canCreatePymt)
        throws CreateException {
    }
