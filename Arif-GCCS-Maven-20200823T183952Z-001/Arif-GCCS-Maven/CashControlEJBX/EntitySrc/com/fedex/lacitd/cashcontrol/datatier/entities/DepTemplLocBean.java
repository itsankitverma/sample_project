/**
 * @(#)DepTemplLocBean.java			Tue Aug 02 15:38:50 VET 2005
 * 
 * FedEx
 * Cash Control
 * 
...
public abstract class DepTemplLocBean implements EntityBean {

    private EntityContext _ctx;
    public DepTemplLocBean() {
    }
    /**
     ...
     */
    public com.fedex.lacitd.cashcontrol.datatier.entities.DepTemplLocPK ejbCreate(String locationCd, Integer templId)
     ...
     */
    public void ejbPostCreate(String locationCd, Integer templId)
        throws CreateException {
    }
