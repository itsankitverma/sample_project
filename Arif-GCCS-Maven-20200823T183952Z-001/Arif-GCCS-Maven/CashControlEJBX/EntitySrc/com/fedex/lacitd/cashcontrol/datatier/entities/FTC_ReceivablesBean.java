...
public abstract class FTC_ReceivablesBean implements EntityBean {

    private EntityContext _ctx;
    public FTC_ReceivablesBean() {
    }
    /**
     ...
     * @param ftcAmt - double of ftcAmt
     */
    public abstract void setFtcAmt(double ftcAmt);

    /**
     * Get the value of ftcAmt
     * @return ftcAmt - double of ftcAmt
     */
    public abstract double getFtcAmt();
     ...
     * @param ftcXmlImpDt - Date of ftcXmlImpDt
     */
    public abstract void setFtcXmlImpDt(Date ftcXmlImpDt);

    /**
     * Get the value of ftcXmlImpDt
     * @return ftcXmlImpDt - Date of ftcXmlImpDt
     */
    public abstract Date getFtcXmlImpDt();
     ...
     */
    public void ejbPostCreate(String recNbr, String customerNm, Date recDt, String invCurrency, double ftcAmt, double ancChargeAmt, double recAmt, String locationCd, String awbNbr, String tinUniqId, double exchRateClnUsed, String employeeId, String paymentCurrency, double cashPaymentAmt, double otherPaymentAmt, int otherPaymentType, String otherDocNbr, double dex16CashPayment, double dex16FreightAmt, double dex16OtherPaymentAmt, String dex16OtherDocNbr, String dex16ScanSeqNbr, String chngStatusEmployeeId, Date chngStatusDt, String closeEmployeeId, Date closeDt, String eodEmployeeId, Date eodDt, String lastScanType, Date lastScanDate, String chkinAgentComment, int trackingStatus, int statusId, int cashDepositSlipId, String cashDepositSlipNbr, int otherDepositSlipId, String otherDepositSlipNbr, String creditCardBatchId, int eodId, Date ftcXmlImpDt, Date pymtImpDt, String otherComment, double recvPrepyAmt, String origCustNm, String custChngEmpId, double origRecAmt, String amtChngEmpId, String rcptNbr, String origRcptNbr, String rcptChngEmpId, String origEmployeeId, String reassEmpId, Integer dualRecIdNbr, String dupAwbFlg, String billAccount,Date miscDate,String miscNbr)
        throws CreateException {
    }
