...
public abstract class RecStatusBean implements EntityBean {

    private EntityContext _ctx;
    public RecStatusBean() {
    }
    /**
     ...
     */
    public abstract void setRodPgFlg(int rodPgFlg);

    /**
     * Get the value of rodPgFlg
     * @return rodPgFlg - int of rodPgFlg
     */
    public abstract int getRodPgFlg();

    /**
     * This is the initialization method that corresponds to the
     * create() method in the Home interface
     */
    public java.lang.Integer ejbCreate(Integer statusId, String description, int rodPgFlg)
        throws CreateException {
        setStatusId(statusId);
        setDescription(description);
        setRodPgFlg(rodPgFlg);
        return null;
    }
     ...
     */
    public void ejbPostCreate(Integer statusId, String description, int rodPgFlg)
        throws CreateException {
    }
