/**
 * @(#)RecExpSrchgBean.java			Tue Aug 02 15:38:50 VET 2005
 * 
 * FedEx
 * Cash Control
 * 
...
public abstract class RecExpSrchgBean implements EntityBean {

    private EntityContext _ctx;
    public RecExpSrchgBean() {
    }
    /**
     ...
     */
    public com.fedex.lacitd.cashcontrol.datatier.entities.RecExpSrchgPK ejbCreate(Integer recId, String surchargeCd, double appliedAmt)
