...
public class COD_ReceivablesVO implements java.io.Serializable {
    ...
    private double _dex11CashPayment;
    private double _dex11FreightAmt;
    private double _dex11OtherPaymentAmt;
    private String _dex11OtherDocNbr;
    private String _dex11ScanSeqNbr;
    ...
    public COD_ReceivablesVO(Integer recId, String recNbr, String customerNm, Date recDt, String invCurrency, double codAmt, double ancChargeAmt, double recAmt, String locationCd, String awbNbr, String tinUniqId, double exchRateClnUsed, String employeeId, String paymentCurrency, double cashPaymentAmt, double otherPaymentAmt, int otherPaymentType, String otherDocNbr, double dex11CashPayment, double dex11FreightAmt, double dex11OtherPaymentAmt, String dex11OtherDocNbr, String dex11ScanSeqNbr, String chngStatusEmployeeId, Date chngStatusDt, String closeEmployeeId, Date closeDt, String eodEmployeeId, Date eodDt, String lastScanType, Date lastScanDate, String chkinAgentComment, int trackingStatus, int statusId, int cashDepositSlipId, String cashDepositSlipNbr, int otherDepositSlipId, String otherDepositSlipNbr, String creditCardBatchId, int eodId, Date codXmlImpDt, Date pymtImpDt, String otherComment, double recvPrepyAmt, String origCustNm, String custChngEmpId, double origRecAmt, String amtChngEmpId, String rcptNbr, String origRcptNbr, String rcptChngEmpId, String origEmployeeId, String reassEmpId, Integer dualRecIdNbr, String dupAwbFlg, String billAccount,java.util.Date miscDate,String miscNbr) {
        ...
        _dex11CashPayment = dex11CashPayment;
        _dex11FreightAmt = dex11FreightAmt;
        _dex11OtherPaymentAmt = dex11OtherPaymentAmt;
        _dex11OtherDocNbr = dex11OtherDocNbr;
        _dex11ScanSeqNbr = dex11ScanSeqNbr;
    ...
    // setter getter for the two columns added miscDate, miscNbr
    ...
    public String toString() {
        ...
        stringBuffer.append("CodAmt: " + _codAmt);
        ...
        stringBuffer.append("Dex11CashPayment: " + _dex11CashPayment);
        stringBuffer.append("Dex11FreightAmt: " + _dex11FreightAmt);
        stringBuffer.append("Dex11OtherPaymentAmt: " + _dex11OtherPaymentAmt);
        stringBuffer.append("Dex11OtherDocNbr: " + _dex11OtherDocNbr);
        stringBuffer.append("Dex11ScanSeqNbr: " + _dex11ScanSeqNbr);
        ...
        stringBuffer.append("CodXmlImpDt: " + _codXmlImpDt);
