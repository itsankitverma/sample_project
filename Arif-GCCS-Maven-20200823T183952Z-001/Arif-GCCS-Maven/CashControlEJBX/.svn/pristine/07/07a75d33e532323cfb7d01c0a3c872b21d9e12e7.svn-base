/**
 * @(#)DepTemplPymtTypeManager.java			Tue Aug 02 15:38:51 VET 2005
 * 
 * FedEx
 * Cash Control
 * 
...
public interface DepTemplPymtTypeManager extends EJBObject {
    ...
    public void setDepTemplPymtType(DepTemplPymtTypeVO depTemplPymtTypeVO)
        throws RemoteException, DepTemplPymtTypeException;
