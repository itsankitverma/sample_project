/**
 * @(#)InCageExceptionsManager.java			Tue Aug 02 15:38:51 VET 2005
 * 
 * FedEx
 * Cash Control
 * 
...
public interface InCageExceptionsManager extends EJBObject {
    ...
    public void setInCageExceptions(InCageExceptionsVO inCageExceptionsVO)
        throws RemoteException, InCageExceptionsException;
