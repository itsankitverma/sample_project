...
public abstract class ReceivablesBean implements EntityBean {
    ...
    /**
     * Set the value of rodAmt
     * @param rodAmt - double of rodAmt
     */
    public abstract void setRodAmt(double rodAmt);

    /**
     * Get the value of rodAmt
     * @return rodAmt - double of rodAmt
     */
    public abstract double getRodAmt();
     ...
     * @param dex16CashPayment - double of dex16CashPayment
     */
    public abstract void setDex16CashPayment(double dex16CashPayment);

    /**
     * Get the value of dex16CashPayment
     * @return dex16CashPayment - double of dex16CashPayment
     */
    public abstract double getDex16CashPayment();

    /**
     * Set the value of dex16FreightAmt
     * @param dex16FreightAmt - double of dex16FreightAmt
     */
    public abstract void setDex16FreightAmt(double dex16FreightAmt);

    /**
     * Get the value of dex16FreightAmt
     * @return dex16FreightAmt - double of dex16FreightAmt
     */
    public abstract double getDex16FreightAmt();

    /**
     * Set the value of dex16OtherPaymentAmt
     * @param dex16OtherPaymentAmt - double of dex16OtherPaymentAmt
     */
    public abstract void setDex16OtherPaymentAmt(double dex16OtherPaymentAmt);

    /**
     * Get the value of dex16OtherPaymentAmt
     * @return dex16OtherPaymentAmt - double of dex16OtherPaymentAmt
     */
    public abstract double getDex16OtherPaymentAmt();

    /**
     * Set the value of dex16OtherDocNbr
     * @param dex16OtherDocNbr - String of dex16OtherDocNbr
     */
    public abstract void setDex16OtherDocNbr(String dex16OtherDocNbr);

    /**
     * Get the value of dex16OtherDocNbr
     * @return dex16OtherDocNbr - String of dex16OtherDocNbr
     */
    public abstract String getDex16OtherDocNbr();

    /**
     * Set the value of dex16ScanSeqNbr
     * @param dex16ScanSeqNbr - String of dex16ScanSeqNbr
     */
    public abstract void setDex16ScanSeqNbr(String dex16ScanSeqNbr);

    /**
     * Get the value of dex16ScanSeqNbr
     * @return dex16ScanSeqNbr - String of dex16ScanSeqNbr
     */
    public abstract String getDex16ScanSeqNbr();
    ...
    /**
     * Set the value of rodXmlImpDt
     * @param rodXmlImpDt - Date of rodXmlImpDt
     */
    public abstract void setRodXmlImpDt(Date rodXmlImpDt);

    /**
     * Get the value of rodXmlImpDt
     * @return rodXmlImpDt - Date of rodXmlImpDt
     */
    public abstract Date getRodXmlImpDt();
    ...
    public java.lang.Integer ejbCreate(String recNbr, String customerNm, Date recDt, String invCurrency, double rodAmt, double ancChargeAmt, double recAmt, String locationCd, String awbNbr, String tinUniqId, double exchRateClnUsed, String employeeId, String paymentCurrency, double cashPaymentAmt, double otherPaymentAmt, int otherPaymentType, String otherDocNbr, double dex16CashPayment, double dex16FreightAmt, double dex16OtherPaymentAmt, String dex16OtherDocNbr, String dex16ScanSeqNbr, String chngStatusEmployeeId, Date chngStatusDt, String closeEmployeeId, Date closeDt, String eodEmployeeId, Date eodDt, String lastScanType, Date lastScanDate, String chkinAgentComment, int trackingStatus, int statusId, int cashDepositSlipId, String cashDepositSlipNbr, int otherDepositSlipId, String otherDepositSlipNbr, String creditCardBatchId, int eodId, Date rodXmlImpDt, Date pymtImpDt, String otherComment, double recvPrepyAmt, String origCustNm, String custChngEmpId, double origRecAmt, String amtChngEmpId, String rcptNbr, String origRcptNbr, String rcptChngEmpId, String origEmployeeId, String reassEmpId, Integer dualRecIdNbr, String dupAwbFlg, String billAccount,Date miscDate,String miscNbr)
        ...
        setDex16CashPayment(dex16CashPayment);
        setDex16FreightAmt(dex16FreightAmt);
        setDex16OtherPaymentAmt(dex16OtherPaymentAmt);
        setDex16OtherDocNbr(dex16OtherDocNbr);
        setDex16ScanSeqNbr(dex16ScanSeqNbr);
     ...
     */
    public void ejbPostCreate(String recNbr, String customerNm, Date recDt, String invCurrency, double rodAmt, double ancChargeAmt, double recAmt, String locationCd, String awbNbr, String tinUniqId, double exchRateClnUsed, String employeeId, String paymentCurrency, double cashPaymentAmt, double otherPaymentAmt, int otherPaymentType, String otherDocNbr, double dex16CashPayment, double dex16FreightAmt, double dex16OtherPaymentAmt, String dex16OtherDocNbr, String dex16ScanSeqNbr, String chngStatusEmployeeId, Date chngStatusDt, String closeEmployeeId, Date closeDt, String eodEmployeeId, Date eodDt, String lastScanType, Date lastScanDate, String chkinAgentComment, int trackingStatus, int statusId, int cashDepositSlipId, String cashDepositSlipNbr, int otherDepositSlipId, String otherDepositSlipNbr, String creditCardBatchId, int eodId, Date rodXmlImpDt, Date pymtImpDt, String otherComment, double recvPrepyAmt, String origCustNm, String custChngEmpId, double origRecAmt, String amtChngEmpId, String rcptNbr, String origRcptNbr, String rcptChngEmpId, String origEmployeeId, String reassEmpId, Integer dualRecIdNbr, String dupAwbFlg, String billAccount,Date miscDate,String miscNbr)
        throws CreateException {
    }
