/**
 * @(#)PymtTypeLocBean.java			Tue Aug 02 15:38:50 VET 2005
 * 
 * FedEx
 * Cash Control
 * 
...
public abstract class PymtTypeLocBean implements EntityBean {

    private EntityContext _ctx;
    public PymtTypeLocBean() {
    }
    /**
     ...
     */
    public com.fedex.lacitd.cashcontrol.datatier.entities.PymtTypeLocPK ejbCreate(Integer paymentTypeId, String locationCd)
     ...
     */
    public void ejbPostCreate(Integer paymentTypeId, String locationCd)
        throws CreateException {
    }
