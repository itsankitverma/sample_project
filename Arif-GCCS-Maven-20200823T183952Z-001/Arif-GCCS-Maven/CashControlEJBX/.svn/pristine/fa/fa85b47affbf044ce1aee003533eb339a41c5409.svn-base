/**
 * @(#)PoaSurchargesBean.java			Tue Aug 02 15:38:50 VET 2005
 * 
 * FedEx
 * Cash Control
 * 
...
public abstract class PoaSurchargesBean implements EntityBean {

    private EntityContext _ctx;
    public PoaSurchargesBean() {
    }
    /**
     ...
     */
    public com.fedex.lacitd.cashcontrol.datatier.entities.PoaSurchargesPK ejbCreate(Integer poaDetailId, String surchargeCd, double appliedAmt)
        throws CreateException {
        setPoaDetailId(poaDetailId);
     ...
     */
    public void ejbPostCreate(Integer poaDetailId, String surchargeCd, double appliedAmt)
        throws CreateException {
    }
