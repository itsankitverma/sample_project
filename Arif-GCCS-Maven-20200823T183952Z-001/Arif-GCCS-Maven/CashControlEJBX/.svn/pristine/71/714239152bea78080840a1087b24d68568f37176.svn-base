/**
 * @(#)DepTemplPymtTypeBean.java			Tue Aug 02 15:38:50 VET 2005
 * 
 * FedEx
 * Cash Control
 * 
...
public abstract class DepTemplPymtTypeBean implements EntityBean {

    private EntityContext _ctx;
    public DepTemplPymtTypeBean() {
    }
    /**
     ...
     */
    public com.fedex.lacitd.cashcontrol.datatier.entities.DepTemplPymtTypePK ejbCreate(Integer paymentTypeId, Integer templId)
     ...
     */
    public void ejbPostCreate(Integer paymentTypeId, Integer templId)
        throws CreateException {
    }
