/**
 * @(#)EmployeeClearingManager.java			Tue Aug 02 15:38:51 VET 2005
 * 
 * FedEx
 * Cash Control
 * 
...
public interface EmployeeClearingManager extends EJBObject {
    ...
    public void setEmployeeClearing(EmployeeClearingVO employeeClearingVO)
        throws RemoteException, EmployeeClearingException;
