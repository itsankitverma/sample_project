/**
 * @(#)PymtImptErrorDtlManager.java			Tue Aug 02 15:38:51 VET 2005
 * 
 * FedEx
 * Cash Control
 * 
...
public interface PymtImptErrorDtlManager extends EJBObject {
    ...
    public void setPymtImptErrorDtl(PymtImptErrorDtlVO pymtImptErrorDtlVO)
        throws RemoteException, PymtImptErrorDtlException;
