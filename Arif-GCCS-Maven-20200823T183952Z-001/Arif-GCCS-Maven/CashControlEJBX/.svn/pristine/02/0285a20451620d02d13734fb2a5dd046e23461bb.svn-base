/**
 * @(#)EmpXLocationXRoleManager.java			Tue Aug 02 15:38:51 VET 2005
 * 
 * FedEx
 * Cash Control
 * 
...
public interface EmpXLocationXRoleManager extends EJBObject {
    ...
    public void setEmpXLocationXRole(EmpXLocationXRoleVO empXLocationXRoleVO)
        throws RemoteException, EmpXLocationXRoleException;
