/**
 * @(#)PrepSurchargesManager.java			Tue Aug 02 15:38:51 VET 2005
 * 
 * FedEx
 * Cash Control
 * 
...
public interface PrepSurchargesManager extends EJBObject {
    ...
    public void setPrepSurcharges(PrepSurchargesVO prepSurchargesVO)
        throws RemoteException, PrepSurchargesException;
