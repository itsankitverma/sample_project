 ...
 * @author  ccardenas
 */
public class RODScanProcessorSTAT44 implements java.io.Serializable {
    ...
    public RODScanProcessorSTAT44() {
    }

    public Collection processLastScans(Collection awbs,Collection results) throws Exception{
            ...
            if(!colAwbs.isEmpty()){
                ...
                for(int i=1;i<=threadsNumber;i++){
                    RODProcessSTAT44Runnable rq=new RODProcessSTAT44Runnable();
                    rq.setErrors(errors);
