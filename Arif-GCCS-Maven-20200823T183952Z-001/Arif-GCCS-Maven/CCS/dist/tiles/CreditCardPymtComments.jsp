...
<script>
    function saveComment(){
        if(document.forms['CreditCardPymtCommForm'].newComment.value.length==0){
            alert('<bean:message key="app.messages.js.MustEnterAComment" />');
        }else{
            document.forms['CreditCardPymtCommForm'].action.value='addComment';
            document.forms['CreditCardPymtCommForm'].submit();
        }    
    }
</script>
<nested:form action="/CreditCardPymtComm" >
