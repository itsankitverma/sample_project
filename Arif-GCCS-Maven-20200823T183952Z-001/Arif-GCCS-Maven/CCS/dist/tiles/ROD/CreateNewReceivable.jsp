...
<script>
    function addReceivable(){
        var msg=validate();
        if(msg==""){
            document.forms['AddReceivableForm'].action.value="SaveAssignThis";
    ...
    //trim doesn't work in IE , so adding a custom trim function
...
<TABLE borderColor="#000099" cellSpacing=5 cellPadding=5 border="1" width="100%">
  ...
  <TR>
    <TD bgColor="#660099" colSpan=2>
      <DIV align=center><FONT color="#ff9933" size=3><B><bean:message key="app.messages.AddReceivable" /></B></FONT></DIV></TD></TR>
  <TR>
    <TD align=right><B><bean:message key="app.messages.AWBNumber" /></B></TD>
    <TD><html:text property="recAwbNumber" onblur="this.value=this.value.trim();"/></TD></TR>
  <TR>
  ...
  <TR>
    ...
    <TD>
        <logic:equal name="AddReceivableForm" property="recAmount" value="0">
           <html:text property="recAmount" value="" />
        </logic:equal>   
        <logic:notEqual name="AddReceivableForm" property="recAmount" value="0">
  ...
  <TR>
    ...
    <TD>
        <logic:equal name="AddReceivableForm" property="exchangeRateUsed" value="0">
           <html:text property="exchangeRateUsed" value="" />
        </logic:equal>   
        <logic:notEqual name="AddReceivableForm" property="exchangeRateUsed" value="0">
  ...
  <TR>
    <TD align=middle colSpan=2><INPUT type="button" onclick="addReceivable();" value="<bean:message key="app.messages.AddReceivable" />"></TD>
  </TR>
</TBODY>
</TABLE>
</html:form>
