...
<html:errors />
<logic:present name="CODCourierCashRecapForm">
<script type="text/javascript" src="<html:rewrite page="/scripts/ccs_scripts.js" />"></script>
<script type="text/javascript">
    <bean:size id="paymenTypeCount" name="CODCourierCashRecapForm" property="paymentTypes" />
    var pymtCtgAssoc=new Array(<bean:write name="paymenTypeCount" />);
    <logic:iterate id="elem" name="CODCourierCashRecapForm" property="paymentTypes">
        pymtCtgAssoc["<bean:write name="elem" property="paymentTypeId" />"] = "<bean:write name="elem" property="paymentCtgId" />";
    </logic:iterate>
        
    <bean:size id="banksCount" name="CODCourierCashRecapForm" property="countryBanks" />
    var countryBanksAssoc=new Array(<bean:write name="banksCount" />);
    <logic:iterate id="elem" name="CODCourierCashRecapForm" property="countryBanks">
    ...
    function reassignPayments() {
        var form=document.forms['CODCourierCashRecapForm'];
        var w=400;
        var h=200;
        ...
        var params="summary=false&oldEmployee=<bean:write name="CODCourierCashRecapForm" property="courier"/>";
    ...
    function checkLine(index) {
        ...
        if(status.options[status.selectedIndex].value==1) {
			...
			recDex11Amount=Number(eval("form.elements['receivables["+index+"].recDex11Amount']").value);
            ...
            var error=<logic:equal name="CODCourierCashRecapForm" property="currentCurrency" value="USD"><bean:write name="userProfile" property="errorThresholdUsd" /></logic:equal><logic:notEqual name="CODCourierCashRecapForm" property="currentCurrency" value="USD"><bean:write name="userProfile" property="errorThresholdLocal" /></logic:notEqual>;

			if(Math.abs(recAmount-recDex11Amount) > error || Math.abs(recAmount-(recCashPayment+recOtherPayment)) > error) {
            ...
            comment = document.forms['CODCourierCashRecapForm'].elements['receivables['+index+'].otherComment'].value;
            billAcct = document.forms['CODCourierCashRecapForm'].elements['receivables['+index+'].billAccount'].value;
    ...
    function validate(isClosing) {
        ...
        var index=Number(<bean:write name="offset" />);
        var some=false;
        var canClose=<bean:write name="CODCourierCashRecapForm" property="canClose"/>;
   ...
   function addReceivable(){
        ...
        if(valid=="") {
            ...
            var leftpos=(screen.width-w) / 2;
            var toppos=(screen.height-h) / 2;
            window.open("<html:rewrite page="/COD/AddCODReceivable.do" />?recEmployeeId=<bean:write name="CODCourierCashRecapForm" property="courier"/>&currencyCode=<bean:write name="CODCourierCashRecapForm" property="currentCurrency"/>","addReceivableWindow","scrollbars=yes,innerHeight="+h+",innerWidth="+w+",toolbar=no, directories=no, location=no, status=yes, menubar=no, resizable=no, width="+w+", height="+h+",left="+leftpos+",top="+toppos);
            form.submit();
        }
        else {
            alert(valid);
    ...
    function cashChanged(obj) {
        var form=document.forms['CODCourierCashRecapForm'];
        var index=Number(<bean:write name="offset" />);
        var total=Number(<bean:write name="CODCourierCashRecapForm" property="cashSubTotal"/>);
        while(eval("form.elements['receivables["+index+"].recId']")){
	...
	function quickApplyStatus() {
    	var form=document.forms['CODCourierCashRecapForm'];	
    	var index=Number(0);
	    <bean:size id="recCount" name="CODCourierCashRecapForm" property="receivables" />
	    ...
	    if(recCount1>20){
	        ...
	        while(eval("form.elements['receivables["+index+"].recId']")){
	            if(Number(eval("form.elements['receivables["+index+"].recDex11Amount']").value)>0 &&
    ...
    function otherChanged(obj) {
        var form=document.forms['CODCourierCashRecapForm'];
        var index=Number(<bean:write name="offset" />);
        var totalCheck=Number(<bean:write name="CODCourierCashRecapForm" property="checkSubTotal"/>);
        var totalCreditCard=Number(<bean:write name="CODCourierCashRecapForm" property="creditCardSubTotal"/>);
        var totalDepo=Number(<bean:write name="CODCourierCashRecapForm" property="depositSubTotal"/>);
...
<jsp:include page="CODSplitCurrency.jsp" flush="true" />
<jsp:include page="../Comments.jsp" flush="true" />
<nested:form action="/COD/COD_CourierCashRecap.do">
            ...
            <td bgcolor="#FFFFFF" align="center" valign="middle">
                <b><font color="#73148C" face="Arial" size="3">
                    ...
                    <nested:select property="courier" onchange="changeCourier();" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 8 pt">
                        ...
                        <nested:root name="CODCourierCashRecapForm">
            ...
            <tr>
	            ...
	            <td rowspan="2">
	            	...
	            	<logic:equal name="userProfile" property="gndUsedFlag" value="true" >
	               	...
	               	<img border="0" src="<html:rewrite page="/images/cod.gif" />" width="135" height="33">
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#CE9AFF">
		            <tr height="1">
                        ...
                        <td bgcolor="#FFFF9C" align="left" width="300">
                            ...
                            <c:forEach var="currency" items="${CODCourierCashRecapForm.currentlyUsedCurrencies}">
                                <c:choose>
                                    <c:when test="${currency.currencyCode eq CODCourierCashRecapForm.currentCurrency}">
                                        <c:choose>
                            ...
                            <c:if test="${CODCourierCashRecapForm.dualCurrency eq 'true'}">
                                <c:choose>
                                    <c:when test="${userProfile.splitCurrency eq 'true' and CODCourierCashRecapForm.currentCurrency ne 'split'}">
                                          <a href="javascript:changeTab('split')"> <IMG src="<html:rewrite page="/images/split1.gif" />" border="0"></a>
                                    </c:when>
                                    <c:when test="${userProfile.splitCurrency eq 'true' and CODCourierCashRecapForm.currentCurrency eq 'split'}">
                                          <html:img page="/images/split.gif" border="0"/>
                                    </c:when>
                                </c:choose>
                            </c:if>
                            <logic:notPresent name="alternativeCurrency" >
                                <c:forEach var="currency" items="${CODCourierCashRecapForm.supportedCurrencies}">
				                        ...
				                        <td>
                                            ...
                                            <table border="0" bgcolor="#000000" cellspacing="0" cellpadding="0" width="100%">
                                                <tr>
                                                    <td bgcolor="#FFFF9C" align="center">
                                                        <c:if test="${CODCourierCashRecapForm.currentCurrency ne 'split'}">
                                                        ...
                                                        <c:if test="${userProfile.splitCurrency eq 'true' and CODCourierCashRecapForm.currentCurrency ne 'split'}">
                                                        ...
                                                        <c:if test="${userProfile.quickStatus eq 'true'}">
                                                            <html:link href="javascript:quickApplyStatus()"><img border="0" src="<html:rewrite page="/images/QuickClearCOD" /><bean:message key="app.Language" />.gif" width="113" height="38" ></html:link>
                                                        </c:if>
                                                        <A href="javascript:processScans();"><img border="0" src="<html:rewrite page="/images/ProcessScan" /><bean:message key="app.Language" />.gif"></A>
                                                        <A href="javascript:addReceivable();"><img border="0" src="<html:rewrite page="/images/AddReassCodRec" /><bean:message key="app.Language" />.gif"></A>
                                                    </td>
                                                    <td bgcolor="#FFFF9C" align="left">
                                                         ...
                                                         <util:paging numberOfPages="${CODCourierCashRecapForm.numberOfPages}" pageNumber="${CODCourierCashRecapForm.pageNumber}" varStatus="std">
                                            ...
                                            <div align="left" valign="top">
    						                    <table border="0" width="100%" bgcolor="#000000" cellspacing="1">
							                        <tr>
                                                        <c:choose>
                                                            <c:when test="${CODCourierCashRecapForm.dualCurrency eq 'false' or CODCourierCashRecapForm.currentCurrency ne 'split'}">
							                        ...
							                        <tr>
                        							    ...
                        							    <td bgColor="#73148C" rowspan="2">
                                                            <c:choose>
                                                                <c:when test="${CODCourierCashRecapForm.sortColumn ne 'awb_nbr'}">
                                                                ...
                                                                <c:otherwise>
                                                                    <c:choose>
                                                                        <c:when test="${CODCourierCashRecapForm.sortDirection eq 'desc'}">
							                            ...
							                            <td bgColor="#73148C" rowspan="2">
                                                            <c:choose>
                                                                <c:when test="${CODCourierCashRecapForm.sortColumn ne 'cust_nm'}">
		                        					    ...
		                        					    <td bgColor="#73148C" rowspan="2">
                                                            <c:choose>
                                                                <c:when test="${CODCourierCashRecapForm.sortColumn ne 'awb_dt'}">
                                                        ...
                                                        <c:if test="${CODCourierCashRecapForm.dualCurrency eq 'true' and CODCourierCashRecapForm.currentCurrency eq 'split'}">
							                            ...
							                            <td bgColor="#73148C" rowspan="2">
                                                            <c:choose>
                                                                <c:when test="${CODCourierCashRecapForm.sortColumn ne 'status_id_nbr'}">
                                                        ...
                                                        <!--changes for MISCELLANEOUS_DATE -->
                                                    ...
                                                    <nested:iterate property="receivables" id="rec" offset="offset" length="length" indexId="idx" type="com.fedex.lacitd.cashcontrol.biztier.common.COD_CourierCashRecapTableVO">
                                                        ...
                                                        <nested:hidden property="recDex11Amount" />
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${CODCourierCashRecapForm.currentCurrency eq 'split'}">
                                                        ...
                                                        %>
                                                               <tr>
                                                                    ...
                                                                    <c:choose>
                                                                        <c:when test="${CODCourierCashRecapForm.dualCurrency ne 'true' or CODCourierCashRecapForm.currentCurrency ne 'split'}">
                                                                                ...
                                                                                <TD align=right nowrap  bgColor="<%=bgColor%>"><FONT  face="Verdana, Arial, Helvetica, sans-serif" size="1" color="<%=fontColor%>" ><B><nested:write property="recDex11Amount" formatKey="app.format.NumberFormat" /></B></FONT>
                                                                                    ...
                                                                                    <td bgColor="<%=bgColor%>"><font face="Verdana, Arial, Helvetica, sans-serif" size="1">
                                                                                              <nested:select property="otherPaymentType" onchange="otherChanged(this);" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 8 pt">
                                                                                                 <option>None</option>
                                                                                                 <html:optionsCollection name="CODCourierCashRecapForm" property="paymentTypes" label="shtDesc" value="paymentTypeId"  />
                                                                                              </nested:select>
                                                                                          </font>
                                                                                    </td>
                                                                                    <TD bgColor="<%=bgColor%>" align="center">
                                                                                        <FONT face="Verdana, Arial, Helvetica, sans-serif" size=1>
                                                                                            ...
                                                                                            <A href="javascript:showCommentsWindow(<%=idx.intValue()%>,'receivables','CODCourierCashRecapForm','recComment', 'otherComment',document.CODCourierCashRecapForm.elements['receivables['+<%=idx.intValue()%>+'].billAccount'].value);">
                                                                            ...
                                                                            <c:choose>
                                                                                    <c:when test="${idx%2 eq 0}">
                                                                                        ...
                                                                                        <TD align=right nowrap  bgColor="<%=bgColor%>" rowspan="2"><FONT  face="Verdana, Arial, Helvetica, sans-serif" size="1" color="<%=fontColor%>" ><B>
                                                                                                <nested:write property="recDex11Amount" formatKey="app.format.NumberFormat" /></B></FONT>
                                                                                        </TD>
                                                                                </c:when>
                                                                                <c:otherwise>
                                                    ...
                                                    <tr>
                                                        <td bgcolor="#FFFF9C" colspan="16" align="center">
                                                             <util:paging numberOfPages="${CODCourierCashRecapForm.numberOfPages}" pageNumber="${CODCourierCashRecapForm.pageNumber}" varStatus="std">
                                                                <html-el:link href="javascript:showPage(${std.count})"><c:out value="${std.count}"/></html-el:link>
                                                             </util:paging>
                                                        </td>
                                    ...
                                    <tr>
                                        <td>
						                    ...
						                    <table border="0" width="100%" bgcolor="#000000" cellspacing="1">
                                                ...
                                                <c:choose>
                                                    <c:when test="${CODCourierCashRecapForm.dualCurrency ne 'true' or CODCourierCashRecapForm.currentCurrency ne 'split'}"> <!-- If not Dual currency tab selected -->
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <bean:define id="frm" name="CODCourierCashRecapForm" type="com.fedex.lacitd.cashcontrol.prestier.struts.form.CODCourierCashRecapForm"/>
                                                            <td bgColor="#C0C0C0" >&nbsp;</td>
...
<form name="createReports" method="POST">
        ...
        <input type="HIDDEN" name="employeeId" value="<bean:write name="CODCourierCashRecapForm" property="courier" />">
