...
<jsp:include page="../COD/CODSplitCurrency.jsp" flush="true" />
                                            ...
                                            <table border="0" bgcolor="#000000" cellspacing="0" cellpadding="0" width="100%">
                                                <tr>
                                                    <td bgcolor="#FFFF9C" align="center">
                                                        ...
                                                        <A href="javascript:addReceivable();"><img border="0" src="<html:rewrite page="/images/AddReassFtcRec" /><bean:message key="app.Language" />.gif"></A>
                                                    </td>
