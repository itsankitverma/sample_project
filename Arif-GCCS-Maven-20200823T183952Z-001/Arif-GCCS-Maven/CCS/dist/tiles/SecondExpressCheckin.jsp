...
<tr >
	...
	<table border="0" width="70%" bgcolor="#000000" cellspacing="1" cellpadding="0">
	  <tr>
	    ...
	    <td rowspan="3" align="center" bgcolor="#73148C" height="57"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#FFFFFF"><bean:message key="app.messages.Close" /></font></td>
	  </tr>
      <tr>
	  ...
	  <tr>
   		 <td align="center" bgcolor="#73148C" height="19"><b><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF" size="2"><bean:message key="app.messages.Received" /></font></td>
   		 <td align="center" bgcolor="#73148C" height="19"><b><font face="Verdana, Arial, Helvetica, sans-serif" color="#FFFFFF" size="2"><bean:message key="app.messages.Received" /></font></td>
	  </tr>
<logic:present name="CheckInAgentCashRecapForm" scope="request" >
 ...
 <nested:iterate property="employeeSummaries" id="empSummary" indexId="idx" type="com.fedex.lacitd.cashcontrol.biztier.common.ExpressCheckinTableVO">
    ...
    <nested:hidden property="employeeId" />
         ...
         <td bgcolor="<%=bgColor%>" align="center" width="16%">
             <font  size="2"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><a href="<html:rewrite page="/ShowChkAgtCashRecap.do" />?courier=<nested:write property="employeeId" />&action=GoDetails" ><nested:write property="employeeId" /></a></font>
         </td>
         <td align="left" bgcolor="<%=bgColor%>" height="19"  width="30%"><font face="Verdana, Arial, Helvetica, sans-serif" size="1"><nested:write property="employeeName" /></font></td>
   		 ...
   		 <td align="center" bgcolor="<%=bgColor%>" height="19" width="16%">
 ...
 <nested:empty property="employeeSummaries">
       <tr> 
            <td bgcolor="#ffffff" align="center" colspan="12">
                <font  size="2"><b><font color="red" face="Verdana, Verdana, Arial, Helvetica, sans-serif, Helvetica, sans-serif"><bean:message key="app.messages.EmptyBecauseClosedDay" /></font></b>
            </td>
       </tr> 
 </nested:empty>
</logic:present>
...
<tr>
	...
	<td bgcolor="#FFFF9C" align="left" ><html:link page="/ShowChkAgtCashRecap.do"><html:img page="/images/arrowGroundAncBack.gif" width="28" height="17" border="0" alt="More Payments" /></html:link></td>
	<td  width="1" bgcolor="#808080">&nbsp;</td>
</tr>
<tr>
	<td  width="1" bgcolor="#808080">&nbsp;</td>
