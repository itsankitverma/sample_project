  ...
  <xsl:attribute-set name="CenteredBlock" foa:class="block">
	...
	<xsl:template match="REPORT/ROD_RECEIVABLES" foa:name="List" foa:class="table" foa:group="simple-table">
		<xsl:if test="count(//REPORT/ROD_RECEIVABLES/RECEIVABLE)">
			...
			<fo:table foa:name="List" foa:group="simple-table" table-layout="fixed" width="21cm" space-before="0.5cm" xsl:use-attribute-sets=" Table1" table-omit-footer-at-break="true">
				<fo:table-column column-number="1" column-width="1cm"/>
				<fo:table-column column-number="2" column-width="1.7cm"/>
				<fo:table-column column-number="3" column-width="1.5cm"/>
				<fo:table-column column-number="4" column-width="0.9cm"/>
...
<!--COD PART-->
	...
	<xsl:template match="REPORT/PREP_AWBS" foa:name="List" foa:class="table" foa:group="simple-table">
		<xsl:if test="count(//REPORT/PREP_AWBS/AWBS)">
			...
			<fo:table foa:name="List" foa:group="simple-table" table-layout="fixed" width="19cm" space-before="0.5cm" xsl:use-attribute-sets=" Table1" table-omit-footer-at-break="true">
				<fo:table-column column-number="1" column-width="1cm"/>
				<fo:table-column column-number="2" column-width="1.7cm"/>
				<fo:table-column column-number="3" column-width="1.2cm"/>
