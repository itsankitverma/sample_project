  ...
  <xsl:attribute-set name="CenteredBlock" foa:class="block">
	...
	<xsl:template match="REPORT/HEADER/LOCATION" foa:name="Month" foa:class="block" foa:group="paragraph">
		<fo:block xsl:use-attribute-sets=" CenteredBlock">
             		     Receivables with POD without Payments
    		</fo:block>
	...
	<xsl:template match="REPORT/RECEIVABLES/RECEIVABLE/EMPLOYEE_ID" foa:name="List" foa:class="table-cell" foa:group="simple-table" foa:type="table-cell">
	...
	<xsl:template match="REPORT/RECEIVABLES/RECEIVABLE/AWB_NBR" foa:name="List" foa:class="table-cell" foa:group="simple-table" foa:type="table-cell">
		<fo:table-cell foa:name="List" foa:group="simple-table" column-number="{position()}" text-align="center" xsl:use-attribute-sets=" TableCell1Right">
			<fo:block font-size="10pt">
				<xsl:apply-templates/>
			</fo:block>
	...
	<xsl:template match="REPORT/RECEIVABLES/RECEIVABLE/REC_NBR" foa:name="List" foa:class="table-cell" foa:group="simple-table" foa:type="table-cell">
		<fo:table-cell foa:name="List" foa:group="simple-table" column-number="{position()}" text-align="center" xsl:use-attribute-sets=" TableCell1Right">
			<fo:block font-size="10pt">
				<xsl:apply-templates/>
			</fo:block>
	...
	<xsl:template match="REPORT/RECEIVABLES/RECEIVABLE/CUSTOMER_NM" foa:name="List" foa:class="table-cell" foa:group="simple-table" foa:type="table-cell">
	...
	<xsl:template match="REPORT/RECEIVABLES/RECEIVABLE/REC_DT" foa:name="List" foa:class="table-cell" foa:group="simple-table" foa:type="table-cell">
		<fo:table-cell foa:name="List" foa:group="simple-table" column-number="{position()}" text-align="center" xsl:use-attribute-sets=" TableCell1Right">
			<fo:block font-size="10pt">
				<xsl:apply-templates/>
			</fo:block>
	...
	<xsl:template match="REPORT/RECEIVABLES/RECEIVABLE/DESCRIPTION" foa:name="List" foa:class="table-cell" foa:group="simple-table" foa:type="table-cell">
		<fo:table-cell foa:name="List" foa:group="simple-table" column-number="{position()}"  text-align="center" xsl:use-attribute-sets=" TableCell1Right">
			<fo:block font-size="10pt">
				<xsl:apply-templates/>
			</fo:block>
