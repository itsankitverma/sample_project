...
/**
 * COD detail screen form class
 * @author  ccardenas
 */


public class CODCourierCashRecapForm extends ActionForm implements java.io.Serializable{
    private List receivables=ListUtils.lazyList(new ArrayList(),new Factory() {
                                                                          public Object create() {
                                                                                return new COD_CourierCashRecapTableVO();
                                                                          }
                                                                       } );
    ...
    public CODCourierCashRecapForm() {
    }
