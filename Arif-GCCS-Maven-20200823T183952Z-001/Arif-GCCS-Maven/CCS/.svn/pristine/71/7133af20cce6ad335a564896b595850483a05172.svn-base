  ...
  <xsl:attribute-set name="CenteredBlock" foa:class="block">
	...
	<xsl:template match="REPORT/COD_RECEIVABLES" foa:name="List" foa:class="table" foa:group="simple-table">
		<fo:table foa:name="List" foa:group="simple-table" table-layout="fixed" width="19cm" xsl:use-attribute-sets=" Table1" table-omit-footer-at-break="true">
			...
			<fo:table-header>
				<fo:table-row>
					<fo:table-cell xsl:use-attribute-sets=" TableCell1" text-align="center" number-rows-spanned="2">
						<fo:block>
	                        Awb Number
	                   </fo:block>
					</fo:table-cell>
					...
					<fo:table-cell xsl:use-attribute-sets=" TableCell1" text-align="center" number-columns-spanned="3">
						<fo:block>
	                        COD Receivable
	                   </fo:block>
					</fo:table-cell>
				...
				<fo:table-row>
					...
					<fo:table-cell xsl:use-attribute-sets="TableCell1" text-align="right">
						<fo:block font-size="10pt">
							<xsl:value-of disable-output-escaping="yes" select="format-number(sum(//RECEIVABLE/REC_AMOUNT),'###########0.00')"/>
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
			</fo:table-footer>
	...
	<xsl:template match="REPORT/COD_RECEIVABLES/RECEIVABLE" foa:name="List" foa:class="table-row" foa:group="simple-table" foa:type="table-row">
		<fo:table-row foa:name="List" foa:group="simple-table" xsl:use-attribute-sets=" TableRow1">
			<xsl:apply-templates/>
		</fo:table-row>
	</xsl:template>
	<xsl:template match="REPORT/COD_RECEIVABLES/RECEIVABLE/REC_AWB_NUMBER" foa:name="List" foa:class="table-cell" foa:group="simple-table" foa:type="table-cell">
		<fo:table-cell foa:name="List" foa:group="simple-table" column-number="{position()}" xsl:use-attribute-sets=" TableCell1Right">
			<fo:block font-size="10pt">
				<xsl:apply-templates/>
			</fo:block>
		</fo:table-cell>
	</xsl:template>
	<xsl:template match="REPORT/COD_RECEIVABLES/RECEIVABLE/REC_CUSTOMER_NAME" foa:name="List" foa:class="table-cell" foa:group="simple-table" foa:type="table-cell">
	...
	<xsl:template match="REPORT/COD_RECEIVABLES/RECEIVABLE/REC_NUMBER" foa:name="List" foa:class="table-cell" foa:group="simple-table" foa:type="table-cell">
		<fo:table-cell foa:name="List" foa:group="simple-table" column-number="{position()}" xsl:use-attribute-sets=" TableCell1Right">
			<fo:block font-size="10pt">
				<xsl:apply-templates/>
			</fo:block>
	...
	<xsl:template match="REPORT/COD_RECEIVABLES/RECEIVABLE/REC_DATE" foa:name="List" foa:class="table-cell" foa:group="simple-table" foa:type="table-cell">
		<fo:table-cell foa:name="List" foa:group="simple-table" column-number="{position()}" text-align="center"  xsl:use-attribute-sets=" TableCell1">
			<fo:block font-size="10pt">
				<xsl:apply-templates/>
			</fo:block>
		</fo:table-cell>
	</xsl:template>
	<xsl:template match="REPORT/COD_RECEIVABLES/RECEIVABLE/REC_AMOUNT" foa:name="List" foa:class="table-cell" foa:group="simple-table" foa:type="table-cell">
		<fo:table-cell foa:name="List" foa:group="simple-table" column-number="{position()}" xsl:use-attribute-sets=" TableCell1Right">
			<fo:block font-size="10pt">
				<xsl:apply-templates/>
			</fo:block>
