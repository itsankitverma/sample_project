 ...
 * @author  ccardenas
 */
public class AddCODReceivablesAction extends Action implements java.io.Serializable{
    public AddCODReceivablesAction() {
    }
...
*/
    ...
    throws Exception {
        ...
        AddCODReceivableForm frm=(AddCODReceivableForm)form;
        ...
        if("FindReceivable".equals(request.getParameter("action"))){
            ...
            request.setAttribute("AddCODReceivableForm",form);
...
*/ {            
    ...
    HttpServletResponse response)
    throws Exception {
       AddCODReceivableForm frm=null; 
       try{
            frm=(AddCODReceivableForm)form;
            CODBizDelegate biz=new CODBizDelegate();
            ...
            switch(result){
                 ...
                 case 1: {
                            ...
                            if(empVO==null){
                                empVO=new EmployeeVO(frm.getRecEmployeeId(),"Unknown Employee","","","COD",new java.util.Date(),"0",0,null,0,0,null,1);
                            }    
                            ...
                            saveErrors(request,ae);                                
                            request.setAttribute("AddCODReceivableForm",frm);
    ...
    throws Exception {
       ...
       try{
            ...
            COD_ReceivablesVO recVO=new COD_ReceivablesVO();
            ...
            switch(result){
                ...
                //insert the AWB  
                if (biz.addCOD_Receivable(recVO)){
                    request.setAttribute("submitParent","submitParent");                    
                    return mapping.findForward("CloseWindow");                
                }else{
                	//could not reassign? show the error.
    ...
    throws Exception {
       try{
            ...
            //get the Receivable
            COD_ReceivablesVO recVO=biz.getCOD_Receivables(frm.getRecId());
    ...
    private Collection addWithnoDuplicated(CODBizDelegate biz, Collection recsNew, ReceivablesByAwbVO rec, ActionErrors ae) throws BizDelegateException {
