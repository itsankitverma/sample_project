...
<table width="100%" border="0" cellspacing="1" cellpadding="0" align="center" bgcolor="#000000" bordercolor="#000099">
  <tr>
    <td align="center" bgcolor="#660099" colspan="10"><font size="+2"color="#ffffff" ><b><bean:message key="app.messages.ExternalFTCFilesImport" /></b></font></td>
  </tr>
  <tr>
...
<logic:present name="colFtcFileDetails" scope="request" >
 <logic:iterate name="colFtcFileDetails" id="elem" indexId="idx" type="com.fedex.lacitd.cashcontrol.datatier.valueobject.ReceivablesVO">    
    <%  
