...
<xsl:template name="FOOTER">
	...
	<xsl:template match="/REPORT/BATCHS/BATCH/ROD_PART/ROD_CURR_PART">
		...
		<fo:table foa:name="List" foa:group="simple-table" table-layout="fixed" width="23cm" xsl:use-attribute-sets=" Table1" table-omit-footer-at-break="true">
			<fo:table-column column-number="1" column-width="0.5cm"/>
	...
	<xsl:template match="ROD_RECEIVABLES/ROD_RECEIVABLE/MISCELLANEOUS_NBR">
		<fo:table-cell xsl:use-attribute-sets=" TableCell1">
			<fo:block font-size="9pt" text-align="center">
				<xsl:apply-templates/>
			</fo:block>
	...
	<xsl:template match="ROD_RECEIVABLES/ROD_RECEIVABLE/MISCELLANEOUS_DATE">
		<fo:table-cell xsl:use-attribute-sets=" TableCell1">
			<fo:block font-size="9pt" text-align="center">
				<xsl:apply-templates/>
			</fo:block>
	...
	<xsl:template match="COD_RECEIVABLES/COD_RECEIVABLE/MISCELLANEOUS_NBR">
		<fo:table-cell xsl:use-attribute-sets=" TableCell1">
			<fo:block font-size="9pt" text-align="right">
				<xsl:apply-templates/>
			</fo:block>
	...
	<xsl:template match="COD_RECEIVABLES/COD_RECEIVABLE/MISCELLANEOUS_DATE">
		<fo:table-cell xsl:use-attribute-sets=" TableCell1">
			<fo:block font-size="9pt" text-align="center">
				<xsl:apply-templates/>
			</fo:block>
...
<!--DETAILS FTC-->
	...
	<xsl:template match="FTC_RECEIVABLES/FTC_RECEIVABLE/MISCELLANEOUS_NBR">
		<fo:table-cell xsl:use-attribute-sets=" TableCell1">
			<fo:block font-size="9pt" text-align="center">
				<xsl:apply-templates/>
			</fo:block>
	...
	<xsl:template match="FTC_RECEIVABLES/FTC_RECEIVABLE/MISCELLANEOUS_DATE">
		<fo:table-cell xsl:use-attribute-sets=" TableCell1">
			<fo:block font-size="9pt" text-align="center">
				<xsl:apply-templates/>
			</fo:block>
	...
	<xsl:template match="PREP_AWBS/PREP_AWB/MISCELLANEOUS_NBR">
		<fo:table-cell xsl:use-attribute-sets=" TableCell1">
			<fo:block font-size="9pt" text-align="center">
				 <xsl:apply-templates />
			</fo:block>
	...
	<xsl:template match="PREP_AWBS/PREP_AWB/MISCELLANEOUS_DATE">
		<fo:table-cell xsl:use-attribute-sets=" TableCell1">
			<fo:block font-size="9pt" text-align="center">
				 <xsl:apply-templates />
			</fo:block>
	...
	<xsl:template match="OTHER_PAYMENTS/OTHER_PAYMENT/MISCELLANEOUS_NBR">
		<fo:table-cell xsl:use-attribute-sets=" TableCell1">
			<fo:block font-size="7pt" text-align="center">
				<xsl:apply-templates/>
			</fo:block>
	...
	<xsl:template match="OTHER_PAYMENTS/OTHER_PAYMENT/MISCELLANEOUS_DATE">
		<fo:table-cell xsl:use-attribute-sets=" TableCell1">
			<fo:block font-size="7pt" text-align="center">
				<xsl:apply-templates/>
			</fo:block>
    ...
    <xsl:template match="GRND_TRAK_NBRS/GRND_TRAK_NBR/MISCELLANEOUS_NBR">
        <fo:table-cell xsl:use-attribute-sets=" TableCell1">
            <fo:block font-size="9pt" text-align="center">
                 <xsl:apply-templates />
            </fo:block>
    ...
    <xsl:template match="GRND_TRAK_NBRS/GRND_TRAK_NBR/MISCELLANEOUS_DATE">
        <fo:table-cell xsl:use-attribute-sets=" TableCell1">
            <fo:block font-size="9pt" text-align="center">
                 <xsl:apply-templates />
            </fo:block>
