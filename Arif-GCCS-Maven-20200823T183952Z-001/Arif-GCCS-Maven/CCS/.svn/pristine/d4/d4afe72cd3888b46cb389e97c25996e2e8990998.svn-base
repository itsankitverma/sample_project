 ...
 * @author  ccardenas
 */
public class CurrentCashRecapReport extends GenericReportServlet {
    
    /** Creates a new instance of PendingRecByCourierReport */
    public CurrentCashRecapReport() {
    }
    
    /**
     * Returns the input stream containing the XML to be used
     * on the Current Cash Recap report generation
     *
    ...
    public InputStream getXMLInputStream(HttpServletRequest request, HttpServletResponse response) throws ServletException {
        ...
        try{
            ...
            BufferedOutputStream bos=new BufferedOutputStream(new FileOutputStream("data1.xml"));
