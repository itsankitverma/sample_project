  ...
  <xsl:attribute-set name="CenteredBlock" foa:class="block">
		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			...
			<fo:page-sequence master-reference="PageSeq">
				<fo:flow flow-name="xsl-region-body">
					...
					<xsl:apply-templates select="/REPORT/DISCREPANCIES"/>
				</fo:flow>
			</fo:page-sequence>
		</fo:root>
	</xsl:template>
	<xsl:template match="REPORT/HEADER/LOCATION" foa:name="Month" foa:class="block" foa:group="paragraph">
		<fo:block xsl:use-attribute-sets=" CenteredBlock">
             		     Open Prepaid Discrepancies Report
    		</fo:block>
		<fo:block text-align="center" font-size="16">
  		           Location: <xsl:apply-templates/>          Date: <xsl:value-of select="/REPORT/HEADER/DATE"/>
		</fo:block>
	</xsl:template>
	<xsl:template match="REPORT/DISCREPANCIES" foa:name="List" foa:class="table" foa:group="simple-table">
		<fo:table foa:name="List" foa:group="simple-table"  table-layout="fixed" width="19cm" xsl:use-attribute-sets=" Table1" table-omit-footer-at-break="true">
			...
			<fo:table-column column-number="8" column-width="3.8cm"/>			
			<fo:table-header>
				<fo:table-row>
					<fo:table-cell number-rows-spanned="2" xsl:use-attribute-sets=" TableCell1" text-align="center" >
						<fo:block>
	                        AWB
	                   </fo:block>
					</fo:table-cell>
					...
					<fo:table-cell number-columns-spanned="2" xsl:use-attribute-sets=" TableCell1" text-align="center" >
						<fo:block>
	                       Discrepancy
	                   </fo:block>
					</fo:table-cell>
	...
	<xsl:template match="REPORT/DISCREPANCIES/DISCREPANCY" foa:name="List" foa:class="table-row" foa:group="simple-table" foa:type="table-row">
		<fo:table-row xsl:use-attribute-sets=" TableRow1">
			<xsl:apply-templates/>
		</fo:table-row>
	</xsl:template>
	<xsl:template match="REPORT/DISCREPANCIES/DISCREPANCY/AWB_NBR" foa:name="List" foa:class="table-cell" foa:group="simple-table" foa:type="table-cell">
		<fo:table-cell foa:name="List"  text-align="center" xsl:use-attribute-sets=" TableCell1Right">
			<fo:block font-size="10pt">
				<xsl:apply-templates/>
			</fo:block>
		</fo:table-cell>
	</xsl:template>
	<xsl:template match="REPORT/DISCREPANCIES/DISCREPANCY/SHIP_DATE" foa:name="List" foa:class="table-cell" foa:group="simple-table" foa:type="table-cell">
		<fo:table-cell foa:name="List"  text-align="center"  xsl:use-attribute-sets=" TableCell1">
			<fo:block font-size="10pt">
				<xsl:apply-templates/>
			</fo:block>
		</fo:table-cell>
	</xsl:template>
	<xsl:template match="REPORT/DISCREPANCIES/DISCREPANCY/COURIER_ID" foa:name="List" foa:class="table-cell" foa:group="simple-table" foa:type="table-cell">
		<fo:table-cell foa:name="List"  text-align="center"  xsl:use-attribute-sets=" TableCell1Right">
			<fo:block font-size="10pt">
				<xsl:apply-templates/>
			</fo:block>
	...
	<xsl:template match="REPORT/DISCREPANCIES/DISCREPANCY/PAYMENT_CURRENCY" foa:name="List" foa:class="table-cell" foa:group="simple-table" foa:type="table-cell">
		<fo:table-cell foa:name="List" text-align="center"  xsl:use-attribute-sets=" TableCell1">
			<fo:block font-size="10pt">
				<xsl:apply-templates/>
			</fo:block>
	...
	<xsl:template match="REPORT/DISCREPANCIES/DISCREPANCY/PUX16_AMOUNT" foa:name="List" foa:class="table-cell" foa:group="simple-table" foa:type="table-cell">
		<fo:table-cell foa:name="List" text-align="right"  xsl:use-attribute-sets=" TableCell1">
			<fo:block font-size="10pt">
				<xsl:value-of  select="format-number(.,'###,###,###,##0.00')" />
			</fo:block>
		</fo:table-cell>
	</xsl:template>
	<xsl:template match="REPORT/DISCREPANCIES/DISCREPANCY/COUPON_AMOUNT" foa:name="List" foa:class="table-cell" foa:group="simple-table" foa:type="table-cell">
		<fo:table-cell foa:name="List" text-align="right"  xsl:use-attribute-sets=" TableCell1">
			<fo:block font-size="10pt">
				<xsl:value-of  select="format-number(.,'###,###,###,##0.00')" />
			</fo:block>
	...
	<xsl:template match="REPORT/DISCREPANCIES/DISCREPANCY/DISCREPANCY_FOUND" foa:name="List" foa:class="table-cell" foa:group="simple-table" foa:type="table-cell">
		<fo:table-cell foa:name="List" text-align="left"  xsl:use-attribute-sets=" TableCell1">
			<fo:block font-size="10pt">
				<xsl:apply-templates/>
			</fo:block>
		</fo:table-cell>
	</xsl:template>
	<xsl:template match="REPORT/DISCREPANCIES/DISCREPANCY/DISCREPANCY_RSN" foa:name="List" foa:class="table-cell" foa:group="simple-table" foa:type="table-cell">
		<fo:table-cell foa:name="List" text-align="left"  xsl:use-attribute-sets=" TableCell1">
			<fo:block font-size="10pt">
				<xsl:apply-templates/>
			</fo:block>
