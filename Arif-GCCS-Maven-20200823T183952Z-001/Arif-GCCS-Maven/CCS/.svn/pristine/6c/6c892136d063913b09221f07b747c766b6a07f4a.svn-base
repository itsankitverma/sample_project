...
<nested:form action="/FTC/AddFTCReceivable.do" method="POST">
...
<nested:hidden property="currencyCode" />
  ...
  <TR>
    <TD bgcolor="#73148C" colSpan=10>
      <DIV align=center><FONT face="Arial" color="#FFFFFF" size=3><B><bean:message key="app.messages.FindFTC" /></B></FONT></DIV>
    </TD>
  </TR>
  <tr>
<nested:iterate property="awbs" indexId="idx">
  ...
  <tr>
      <TD align=middle colSpan=10>
        <INPUT type=button onclick="submitForm();" value="<bean:message key="app.messages.FindFTC" />">
    </TD>
  </TR>
</TBODY>
</TABLE>
