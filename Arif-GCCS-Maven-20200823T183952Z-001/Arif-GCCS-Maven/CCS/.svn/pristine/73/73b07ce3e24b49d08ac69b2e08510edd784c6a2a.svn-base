...
/**
 * FTC detail screen form class
 * @author  ccardenas
 */


public class FTCCourierCashRecapForm extends ActionForm implements java.io.Serializable{
    private List receivables=ListUtils.lazyList(new ArrayList(),new Factory() {
                                                                          public Object create() {
                                                                                return new FTC_CourierCashRecapTableVO();
                                                                          }
                                                                       } );
    ...
    public FTCCourierCashRecapForm() {
    }
     ...
     * @param depositTotal New value of property depositTotal.
     */
     ...
     * @param depositSubTotal New value of property depositSubTotal.
     */
