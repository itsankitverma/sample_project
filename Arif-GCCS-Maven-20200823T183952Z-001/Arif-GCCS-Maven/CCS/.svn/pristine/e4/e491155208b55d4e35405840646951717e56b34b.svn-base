 ...
 * @author  ccardenas
 */
public class PendingRecByCourierReport extends GenericReportServlet {
    
    /** Creates a new instance of PendingRecByCourierReport */
    public PendingRecByCourierReport() {
    }
    ...
    public InputStream getXMLInputStream(HttpServletRequest request, HttpServletResponse response) throws ServletException {
        ...
        try{
            ...
            cs=conn.prepareCall("BEGIN SP_PENDING_REC_BY_COUR_REPORT(?,?,?); END;");
