 ...
 * @author  ccardenas
 */
public class AddRODReceivablesAction extends Action implements java.io.Serializable{
    public AddRODReceivablesAction() {
    }
...
*/
    ...
    throws Exception {
        ...
        AddReceivableForm frm=(AddReceivableForm)form;
        ...
        if("FindReceivable".equals(request.getParameter("action"))){
            ...
            request.setAttribute("AddReceivableForm",form);
...
*/ {            
    ...
    HttpServletResponse response)
    throws Exception {
       AddReceivableForm frm=null; 
       try{
            frm=(AddReceivableForm)form;
            RODBizDelegate biz=new RODBizDelegate();
            ...
            switch(result){
                 ...
                 case 1: {
                            ...
                            if(empVO==null){
                                empVO=new EmployeeVO(frm.getRecEmployeeId(),"Unknown Employee","","","ROD",new java.util.Date(),"0",0,null,0,0,null,1);
                            }    
                            ...
                            saveErrors(request,ae);                                
                            request.setAttribute("AddReceivableForm",frm);
    ...
    throws Exception {
       try{
            ...
            //get the Receivable
            ReceivablesVO recVO=biz.getReceivables(frm.getRecId());
    ...
    private Collection addWithnoDuplicated(RODBizDelegate biz, Collection recsNew, ReceivablesByAwbVO rec, ActionErrors ae) throws BizDelegateException {
