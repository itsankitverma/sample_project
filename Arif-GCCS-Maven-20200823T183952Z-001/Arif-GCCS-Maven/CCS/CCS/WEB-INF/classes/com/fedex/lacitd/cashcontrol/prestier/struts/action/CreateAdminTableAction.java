 ...
 */
public class CreateAdminTableAction extends Action {
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        delegate.createAdminTable(tableName);

        LogEventHelper.logEvent(request, Monitoring.MONITORING_EVENT_INSERT, "CreateAdminTableAction createAdminTable()", tableName, true);
