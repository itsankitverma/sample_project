 ...
 */
public class CODAddAwbsAction extends Action implements Serializable {
    
    /** Creates a new instance of CODAddAwbsAction */
    public CODAddAwbsAction() {
    }
    ...
    throws Exception
    {
         CODAddAwbsForm frm=(CODAddAwbsForm)form;
         if(frm==null)  frm=new CODAddAwbsForm();
         
         frm.getAwbsList().add(0,new COD_RecChangesFromScans());        
         
         request.setAttribute("CODAddAwbsForm",frm);
    ...
    throws Exception {
        ...
        // This code is used to get the Cosmos data to complete the information of the COD payments
           try{
                ...
                if(frm.getCosmosScansEnabled()){
                	np=sp.processLastScans(awbs,results,ep.getLocationCd(),comBiz.getLocationCdByCountry(ep.getCountryCd()),ep.getScansLocalDecs(),ep.getScansUsdDecs());
                        ...
                        while(awbsIt.hasNext()){
                              COD_RecChangesFromScans recChanges = (COD_RecChangesFromScans)awbsIt.next();
