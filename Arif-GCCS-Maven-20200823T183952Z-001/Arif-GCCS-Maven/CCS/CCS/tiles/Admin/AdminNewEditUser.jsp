...
<html:hidden name="AdminUserListForm" property="reviewData"/>
		...
		<table border="0" cellspacing="1" cellpadding="0" bgcolor="#000000">
			...
			<tr>
			  ...
			  <td bgcolor="#FFFF9C" colspan="3">
				  ...
				  <html:text  maxlength="10" name="AdminUserListForm" property="userId" tabindex="1" readonly="true"/>
           		  <font size="2" face="Arial" color="#000000">&nbsp&nbsp&nbsp<bean:message key="app.message.ExternalCustomer"/></font>
    			
    			  <html:hidden name="AdminUserListForm" property="extlCustFlg"/>	       		  
           		  <logic:equal value="1" name="AdminUserListForm" property="extlCustFlg">
	           		 &nbsp;&nbsp; <html:img page="/images/hasComment.gif" align="center"/> &nbsp;
           		  </logic:equal>
           		  <logic:equal value="0" name="AdminUserListForm" property="extlCustFlg">
	           		 &nbsp;&nbsp; <html:img page="/images/hasNoComment.gif" align="center"/> &nbsp;
			      </logic:equal>
	       	  </td>
		  </tr>
		  <tr>
		  ...
		  <tr>
			<td bgcolor="#C0C0C0" align="left"><font size="2" face="Arial" color="#000000">
			<bean:message key="app.Password"/></font>
			</td>
			<td bgcolor="#FFFFFF"><html:password maxlength="20" name="AdminUserListForm" property="password1" tabindex="2"/></td>
            <td bgcolor="#C0C0C0">
			<p align="left"><font face="Arial" size="2" color="#000000"><bean:message key="app.Password2"/></font>
			</td>
            <td bgcolor="#FFFFFF"><html:password maxlength="20"name="AdminUserListForm"  property="password2" tabindex="4"/></td>
		  </tr>
          </logic:equal>
		  <tr>
