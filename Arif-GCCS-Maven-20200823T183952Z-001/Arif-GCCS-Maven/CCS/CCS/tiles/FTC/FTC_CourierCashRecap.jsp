...
<html:errors />
<logic:present name="FTCCourierCashRecapForm">
<script type="text/javascript" src="<html:rewrite page="/scripts/ccs_scripts.js" />"></script>
<script type="text/javascript">
    <bean:size id="paymenTypeCount" name="FTCCourierCashRecapForm" property="paymentTypes" />
    var pymtCtgAssoc=new Array(<bean:write name="paymenTypeCount" />);
    <logic:iterate id="elem" name="FTCCourierCashRecapForm" property="paymentTypes">
        pymtCtgAssoc["<bean:write name="elem" property="paymentTypeId" />"] = "<bean:write name="elem" property="paymentCtgId" />";
    </logic:iterate>
        
    <bean:size id="banksCount" name="FTCCourierCashRecapForm" property="countryBanks" />
    var countryBanksAssoc=new Array(<bean:write name="banksCount" />);
    <logic:iterate id="elem" name="FTCCourierCashRecapForm" property="countryBanks">
    ...
    function reassignPayments() {
        ...
        var params="summary=false&oldEmployee=<bean:write name="FTCCourierCashRecapForm" property="courier"/>";
    ...
    function checkLine(index) {
        ...
        if(status.options[status.selectedIndex].value==1) {
            ...
            billAcct = document.forms['FTCCourierCashRecapForm'].elements['receivables['+index+'].billAccount'].value;
    ...
    function validate(isClosing) {
        ...
        var index=Number(<bean:write name="offset" />);
        var some=false;
        var canClose=<bean:write name="FTCCourierCashRecapForm" property="canClose"/>;
   ...
   function addReceivable(){
        ...
        if(valid=="") {
            ...
            var leftpos=(screen.width-w) / 2;
            var toppos=(screen.height-h) / 2;
            window.open("<html:rewrite page="/FTC/AddFTCReceivable.do" />?recEmployeeId=<bean:write name="FTCCourierCashRecapForm" property="courier"/>&currencyCode=<bean:write name="FTCCourierCashRecapForm" property="currentCurrency"/>","addReceivableWindow","scrollbars=yes,innerHeight="+h+",innerWidth="+w+",toolbar=no, directories=no, location=no, status=yes, menubar=no, resizable=no, width="+w+", height="+h+",left="+leftpos+",top="+toppos);
            form.submit();
        }
        else {
            alert(valid);
    ...
    function cashChanged(obj) {
        var form=document.forms['FTCCourierCashRecapForm'];
        var index=Number(<bean:write name="offset" />);
        var total=Number(<bean:write name="FTCCourierCashRecapForm" property="cashSubTotal"/>);
        while(eval("form.elements['receivables["+index+"].recId']")){
	...
	function quickApplyStatus() {
	    ...
	    <bean:size id="recCount" name="FTCCourierCashRecapForm" property="receivables" />
    ...
    function otherChanged(obj) {
        var form=document.forms['FTCCourierCashRecapForm'];
        var index=Number(<bean:write name="offset" />);
        var totalCheck=Number(<bean:write name="FTCCourierCashRecapForm" property="checkSubTotal"/>);
        var totalCreditCard=Number(<bean:write name="FTCCourierCashRecapForm" property="creditCardSubTotal"/>);
        var totalDepo=Number(<bean:write name="FTCCourierCashRecapForm" property="depositSubTotal"/>);
...
<jsp:include page="../FTC/FTCSplitCurrency.jsp" flush="true" />
<jsp:include page="../Comments.jsp" flush="true" />
<nested:form action="/FTC/FTC_CourierCashRecap.do">
            ...
            <td bgcolor="#FFFFFF" align="center" valign="middle">
                <b><font color="#73148C" face="Arial" size="3">
                    ...
                    <nested:select property="courier" onchange="changeCourier();" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 8 pt">
                        ...
                        <nested:root name="FTCCourierCashRecapForm">
	            ...
	            <td rowspan="2">
					...
					<logic:equal name="userProfile" property="codUsedFlag" value="true" >
	                  <html:link href="javascript:toCOD();" >
	               	...
	               	<img border="0" src="<html:rewrite page="/images/ftc.gif" />" width="135" height="33">
                ...
                <table cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#CE9AFF">
		            <tr height="1">
                        ...
                        <td bgcolor="#FFFF9C" align="left" width="300">
                            ...
                            <c:forEach var="currency" items="${FTCCourierCashRecapForm.currentlyUsedCurrencies}">
                                <c:choose>
                                    <c:when test="${currency.currencyCode eq FTCCourierCashRecapForm.currentCurrency}">
                                        <c:choose>
                            ...
                            <c:if test="${FTCCourierCashRecapForm.dualCurrency eq 'true'}">
                                <c:choose>
                                    <c:when test="${userProfile.splitCurrency eq 'true' and FTCCourierCashRecapForm.currentCurrency ne 'split'}">
                                          <a href="javascript:changeTab('split')"> <IMG src="<html:rewrite page="/images/split1.gif" />" border="0"></a>
                                    </c:when>
                                    <c:when test="${userProfile.splitCurrency eq 'true' and FTCCourierCashRecapForm.currentCurrency eq 'split'}">
                                          <html:img page="/images/split.gif" border="0"/>
                                    </c:when>
                                </c:choose>
                            </c:if>
                            <logic:notPresent name="alternativeCurrency" >
                                <c:forEach var="currency" items="${FTCCourierCashRecapForm.supportedCurrencies}">
				                        ...
				                        <td>
                                            ...
                                            <table border="0" bgcolor="#000000" cellspacing="0" cellpadding="0" width="100%">
                                                <tr>
                                                    <td bgcolor="#FFFF9C" align="center">
                                                        <c:if test="${FTCCourierCashRecapForm.currentCurrency ne 'split'}">
                                                        ...
                                                        <c:if test="${userProfile.splitCurrency eq 'true' and FTCCourierCashRecapForm.currentCurrency ne 'split'}">
                                                    ...
                                                    <td bgcolor="#FFFF9C" align="left">
                                                         ...
                                                         <util:paging numberOfPages="${FTCCourierCashRecapForm.numberOfPages}" pageNumber="${FTCCourierCashRecapForm.pageNumber}" varStatus="std">
                                            ...
                                            <div align="left" valign="top">
    						                    <table border="0" width="100%" bgcolor="#000000" cellspacing="1">
							                        <tr>
                                                        <c:choose>
                                                            <c:when test="${FTCCourierCashRecapForm.dualCurrency eq 'false' or FTCCourierCashRecapForm.currentCurrency ne 'split'}">
							                        ...
							                        <tr>
                        							    ...
                        							    <td bgColor="#73148C" rowspan="2">
                                                            <c:choose>
                                                                <c:when test="${FTCCourierCashRecapForm.sortColumn ne 'awb_nbr'}">
                                                                ...
                                                                <c:otherwise>
                                                                    <c:choose>
                                                                        <c:when test="${FTCCourierCashRecapForm.sortDirection eq 'desc'}">
							                            ...
							                            <td bgColor="#73148C" rowspan="2">
                                                            <c:choose>
                                                                <c:when test="${FTCCourierCashRecapForm.sortColumn ne 'cust_nm'}">
		                        					    ...
		                        					    <td bgColor="#73148C" rowspan="2">
                                                            <c:choose>
                                                                <c:when test="${FTCCourierCashRecapForm.sortColumn ne 'awb_dt'}">
                                                        ...
                                                        <c:if test="${FTCCourierCashRecapForm.dualCurrency eq 'true' and FTCCourierCashRecapForm.currentCurrency eq 'split'}">
							                            ...
							                            <td bgColor="#73148C" rowspan="2">
                                                            <c:choose>
                                                                <c:when test="${FTCCourierCashRecapForm.sortColumn ne 'status_id_nbr'}">
                                                    ...
                                                    <nested:iterate property="receivables" id="rec" offset="offset" length="length" indexId="idx" type="com.fedex.lacitd.cashcontrol.biztier.common.FTC_CourierCashRecapTableVO">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${FTCCourierCashRecapForm.currentCurrency eq 'split'}">
                                                        ...
                                                        %>
                                                               <tr>
                                                                    ...
                                                                    <c:choose>
                                                                        <c:when test="${FTCCourierCashRecapForm.dualCurrency ne 'true' or FTCCourierCashRecapForm.currentCurrency ne 'split'}">
                                                                                ...
                                                                                <TD align=right nowrap  bgColor="<%=bgColor%>"><FONT  face="Verdana, Arial, Helvetica, sans-serif" size="1" color="<%=fontColor%>" ><B><nested:write property="recDex16Amount" formatKey="app.format.NumberFormat" /></B></FONT>
                                                                                    ...
                                                                                    <td bgColor="<%=bgColor%>"><font face="Verdana, Arial, Helvetica, sans-serif" size="1">
                                                                                              <nested:select property="otherPaymentType" onchange="otherChanged(this);" style="font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 8 pt">
                                                                                                 <option>None</option>
                                                                                                 <html:optionsCollection name="FTCCourierCashRecapForm" property="paymentTypes" label="shtDesc" value="paymentTypeId"  />
                                                                                              </nested:select>
                                                                                          </font>
                                                                                    </td>
                                                                                    <TD bgColor="<%=bgColor%>" align="center">
                                                                                        <FONT face="Verdana, Arial, Helvetica, sans-serif" size=1>
                                                                                            ...
                                                                                            <A href="javascript:showCommentsWindow(<%=idx.intValue()%>,'receivables','FTCCourierCashRecapForm','recComment', 'otherComment',document.FTCCourierCashRecapForm.elements['receivables['+<%=idx.intValue()%>+'].billAccount'].value);">
                                    ...
                                    <tr>
                                        <td>
						                    ...
						                    <table border="0" width="100%" bgcolor="#000000" cellspacing="1">
                                                ...
                                                <c:choose>
                                                    <c:when test="${FTCCourierCashRecapForm.dualCurrency ne 'true' or FTCCourierCashRecapForm.currentCurrency ne 'split'}"> <!-- If not Dual currency tab selected -->
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <bean:define id="frm" name="FTCCourierCashRecapForm" type="com.fedex.lacitd.cashcontrol.prestier.struts.form.FTCCourierCashRecapForm"/>
                                                            <td bgColor="#C0C0C0" >&nbsp;</td>
...
<form name="createReports" method="POST">
        ...
        <input type="HIDDEN" name="employeeId" value="<bean:write name="FTCCourierCashRecapForm" property="courier" />">
