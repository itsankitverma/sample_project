...
<script>
    function addReceivable(){
        var msg=validate();
        if(msg==""){
            document.forms['AddCODReceivableForm'].action.value="SaveAssignThis";
...
<body>
<html:errors />
<html:form action="/COD/AddCODReceivable.do">
...
<TABLE borderColor="#000099" cellSpacing=5 cellPadding=5 border="1" width="100%">
  ...
  <TR>
    <TD bgColor="#660099" colSpan=2>
      <DIV align=center><FONT color="#ff9933" size=3><B><bean:message key="app.messages.AddCOD" /></B></FONT></DIV></TD></TR>
  <TR>
  ...
  <TR>
    ...
    <TD>
        <logic:equal name="AddCODReceivableForm" property="recAmount" value="0">
           <html:text property="recAmount" value="" />
        </logic:equal>   
        <logic:notEqual name="AddCODReceivableForm" property="recAmount" value="0">
  ...
  <TR>
    ...
    <TD>
        <logic:equal name="AddCODReceivableForm" property="exchangeRateUsed" value="0">
           <html:text property="exchangeRateUsed" value="" />
        </logic:equal>   
        <logic:notEqual name="AddCODReceivableForm" property="exchangeRateUsed" value="0">
  ...
  <TR>
    <TD align=middle colSpan=2><INPUT type="button" onclick="addReceivable();" value="<bean:message key="app.messages.AddCOD" />"></TD>
  </TR>
</TBODY>
</TABLE>
</html:form>
